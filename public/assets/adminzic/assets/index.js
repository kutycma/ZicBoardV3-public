 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lf;function Kb(){if(Lf)return He;Lf=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),p=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),m=Symbol.for("react.context"),_=Symbol.for("react.forward_ref"),j=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),z=Symbol.iterator;function Y(S){return S===null||typeof S!="object"?null:(S=z&&S[z]||S["@@iterator"],typeof S=="function"?S:null)}var P={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,C={};function B(S,X,pe){this.props=S,this.context=X,this.refs=C,this.updater=pe||P}B.prototype.isReactComponent={},B.prototype.setState=function(S,X){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,X,"setState")},B.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function U(){}U.prototype=B.prototype;function O(S,X,pe){this.props=S,this.context=X,this.refs=C,this.updater=pe||P}var ee=O.prototype=new U;ee.constructor=O,K(ee,B.prototype),ee.isPureReactComponent=!0;var ie=Array.isArray;function oe(){}var E={H:null,A:null,T:null,S:null},$=Object.prototype.hasOwnProperty;function ne(S,X,pe){var me=pe.ref;return{$$typeof:s,type:S,key:X,ref:me!==void 0?me:null,props:pe}}function xe(S,X){return ne(S.type,X,S.props)}function N(S){return typeof S=="object"&&S!==null&&S.$$typeof===s}function R(S){var X={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(pe){return X[pe]})}var te=/\/+/g;function M(S,X){return typeof S=="object"&&S!==null&&S.key!=null?R(""+S.key):X.toString(36)}function re(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(oe,oe):(S.status="pending",S.then(function(X){S.status==="pending"&&(S.status="fulfilled",S.value=X)},function(X){S.status==="pending"&&(S.status="rejected",S.reason=X)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function A(S,X,pe,me,ke){var Se=typeof S;(Se==="undefined"||Se==="boolean")&&(S=null);var Ue=!1;if(S===null)Ue=!0;else switch(Se){case"bigint":case"string":case"number":Ue=!0;break;case"object":switch(S.$$typeof){case s:case i:Ue=!0;break;case v:return Ue=S._init,A(Ue(S._payload),X,pe,me,ke)}}if(Ue)return ke=ke(S),Ue=me===""?"."+M(S,0):me,ie(ke)?(pe="",Ue!=null&&(pe=Ue.replace(te,"$&/")+"/"),A(ke,X,pe,"",function(We){return We})):ke!=null&&(N(ke)&&(ke=xe(ke,pe+(ke.key==null||S&&S.key===ke.key?"":(""+ke.key).replace(te,"$&/")+"/")+Ue)),X.push(ke)),1;Ue=0;var lt=me===""?".":me+":";if(ie(S))for(var Ge=0;Ge<S.length;Ge++)me=S[Ge],Se=lt+M(me,Ge),Ue+=A(me,X,pe,Se,ke);else if(Ge=Y(S),typeof Ge=="function")for(S=Ge.call(S),Ge=0;!(me=S.next()).done;)me=me.value,Se=lt+M(me,Ge++),Ue+=A(me,X,pe,Se,ke);else if(Se==="object"){if(typeof S.then=="function")return A(re(S),X,pe,me,ke);throw X=String(S),Error("Objects are not valid as a React child (found: "+(X==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":X)+"). If you meant to render a collection of children, use an array instead.")}return Ue}function J(S,X,pe){if(S==null)return S;var me=[],ke=0;return A(S,me,"","",function(Se){return X.call(pe,Se,ke++)}),me}function x(S){if(S._status===-1){var X=S._result;X=X(),X.then(function(pe){(S._status===0||S._status===-1)&&(S._status=1,S._result=pe)},function(pe){(S._status===0||S._status===-1)&&(S._status=2,S._result=pe)}),S._status===-1&&(S._status=0,S._result=X)}if(S._status===1)return S._result.default;throw S._result}var W=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var X=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(X))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)},H={map:J,forEach:function(S,X,pe){J(S,function(){X.apply(this,arguments)},pe)},count:function(S){var X=0;return J(S,function(){X++}),X},toArray:function(S){return J(S,function(X){return X})||[]},only:function(S){if(!N(S))throw Error("React.Children.only expected to receive a single React element child.");return S}};return He.Activity=w,He.Children=H,He.Component=B,He.Fragment=o,He.Profiler=p,He.PureComponent=O,He.StrictMode=d,He.Suspense=j,He.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=E,He.__COMPILER_RUNTIME={__proto__:null,c:function(S){return E.H.useMemoCache(S)}},He.cache=function(S){return function(){return S.apply(null,arguments)}},He.cacheSignal=function(){return null},He.cloneElement=function(S,X,pe){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var me=K({},S.props),ke=S.key;if(X!=null)for(Se in X.key!==void 0&&(ke=""+X.key),X)!$.call(X,Se)||Se==="key"||Se==="__self"||Se==="__source"||Se==="ref"&&X.ref===void 0||(me[Se]=X[Se]);var Se=arguments.length-2;if(Se===1)me.children=pe;else if(1<Se){for(var Ue=Array(Se),lt=0;lt<Se;lt++)Ue[lt]=arguments[lt+2];me.children=Ue}return ne(S.type,ke,me)},He.createContext=function(S){return S={$$typeof:m,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:h,_context:S},S},He.createElement=function(S,X,pe){var me,ke={},Se=null;if(X!=null)for(me in X.key!==void 0&&(Se=""+X.key),X)$.call(X,me)&&me!=="key"&&me!=="__self"&&me!=="__source"&&(ke[me]=X[me]);var Ue=arguments.length-2;if(Ue===1)ke.children=pe;else if(1<Ue){for(var lt=Array(Ue),Ge=0;Ge<Ue;Ge++)lt[Ge]=arguments[Ge+2];ke.children=lt}if(S&&S.defaultProps)for(me in Ue=S.defaultProps,Ue)ke[me]===void 0&&(ke[me]=Ue[me]);return ne(S,Se,ke)},He.createRef=function(){return{current:null}},He.forwardRef=function(S){return{$$typeof:_,render:S}},He.isValidElement=N,He.lazy=function(S){return{$$typeof:v,_payload:{_status:-1,_result:S},_init:x}},He.memo=function(S,X){return{$$typeof:g,type:S,compare:X===void 0?null:X}},He.startTransition=function(S){var X=E.T,pe={};E.T=pe;try{var me=S(),ke=E.S;ke!==null&&ke(pe,me),typeof me=="object"&&me!==null&&typeof me.then=="function"&&me.then(oe,W)}catch(Se){W(Se)}finally{X!==null&&pe.types!==null&&(X.types=pe.types),E.T=X}},He.unstable_useCacheRefresh=function(){return E.H.useCacheRefresh()},He.use=function(S){return E.H.use(S)},He.useActionState=function(S,X,pe){return E.H.useActionState(S,X,pe)},He.useCallback=function(S,X){return E.H.useCallback(S,X)},He.useContext=function(S){return E.H.useContext(S)},He.useDebugValue=function(){},He.useDeferredValue=function(S,X){return E.H.useDeferredValue(S,X)},He.useEffect=function(S,X){return E.H.useEffect(S,X)},He.useEffectEvent=function(S){return E.H.useEffectEvent(S)},He.useId=function(){return E.H.useId()},He.useImperativeHandle=function(S,X,pe){return E.H.useImperativeHandle(S,X,pe)},He.useInsertionEffect=function(S,X){return E.H.useInsertionEffect(S,X)},He.useLayoutEffect=function(S,X){return E.H.useLayoutEffect(S,X)},He.useMemo=function(S,X){return E.H.useMemo(S,X)},He.useOptimistic=function(S,X){return E.H.useOptimistic(S,X)},He.useReducer=function(S,X,pe){return E.H.useReducer(S,X,pe)},He.useRef=function(S){return E.H.useRef(S)},He.useState=function(S){return E.H.useState(S)},He.useSyncExternalStore=function(S,X,pe){return E.H.useSyncExternalStore(S,X,pe)},He.useTransition=function(){return E.H.useTransition()},He.version="19.2.6",He}var qf;function Rd(){return qf||(qf=1,nd.exports=Kb()),nd.exports}var f=Rd();const Vb=Qb(f),Jb=$b({__proto__:null,default:Vb},[f]);var ad={exports:{}},ts={},ld={exports:{}},id={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yf;function Pb(){if(Yf)return It;Yf=1;var s=Rd();function i(j){var g="https://react.dev/errors/"+j;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)g+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+j+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var d={d:{f:o,r:function(){throw Error(i(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},p=Symbol.for("react.portal");function h(j,g,v){var w=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:p,key:w==null?null:""+w,children:j,containerInfo:g,implementation:v}}var m=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function _(j,g){if(j==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return It.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,It.createPortal=function(j,g){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(i(299));return h(j,g,null,v)},It.flushSync=function(j){var g=m.T,v=d.p;try{if(m.T=null,d.p=2,j)return j()}finally{m.T=g,d.p=v,d.d.f()}},It.preconnect=function(j,g){typeof j=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,d.d.C(j,g))},It.prefetchDNS=function(j){typeof j=="string"&&d.d.D(j)},It.preinit=function(j,g){if(typeof j=="string"&&g&&typeof g.as=="string"){var v=g.as,w=_(v,g.crossOrigin),z=typeof g.integrity=="string"?g.integrity:void 0,Y=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;v==="style"?d.d.S(j,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:w,integrity:z,fetchPriority:Y}):v==="script"&&d.d.X(j,{crossOrigin:w,integrity:z,fetchPriority:Y,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},It.preinitModule=function(j,g){if(typeof j=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var v=_(g.as,g.crossOrigin);d.d.M(j,{crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&d.d.M(j)},It.preload=function(j,g){if(typeof j=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var v=g.as,w=_(v,g.crossOrigin);d.d.L(j,v,{crossOrigin:w,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},It.preloadModule=function(j,g){if(typeof j=="string")if(g){var v=_(g.as,g.crossOrigin);d.d.m(j,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else d.d.m(j)},It.requestFormReset=function(j){d.d.r(j)},It.unstable_batchedUpdates=function(j,g){return j(g)},It.useFormState=function(j,g,v){return m.H.useFormState(j,g,v)},It.useFormStatus=function(){return m.H.useHostTransitionStatus()},It.version="19.2.6",It}var $f;function Fh(){if($f)return sd.exports;$f=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(i){console.error(i)}}return s(),sd.exports=Pb(),sd.exports}/**
 * @license React
...
`)}function vl(y){s.push(`/device?user_id=${encodeURIComponent(String(y.id))}`)}function Wa(y,ue="left"){const de=`${Oe("user.deviceOnlineShort","Online")}: ${Number(y.device_online_count??0)} | ${Oe("user.deviceIpShort","IP")}: ${Number(y.alive_ip??0)}`;return t.jsxs("button",{className:`device-cell-button ${ue==="right"?"align-right":""}`,type:"button",title:ri(y),onClick:()=>vl(y),children:[t.jsx("span",{className:"device-cell-primary",children:ft(y)}),t.jsx("span",{className:"device-cell-secondary",children:de})]})}async function Gn(y){var Ce,gt;const ue=y.subscribe_url;if(!ue){(Ce=window.showToast)==null||Ce.call(window,o("user.toastNoSubscribeUrl"),"error");return}const de=await Va(ue);(gt=window.showToast)==null||gt.call(window,o(de?"user.toastUrlCopied":"common.copyFailed"),de?"success":"error"),N(null)}function mn(y){var ue;N(null),(ue=window.showConfirm)==null||ue.call(window,{message:o("user.confirmResetSecret"),onConfirm:async()=>{var de,Ce;try{await M1(y.id),(de=window.showToast)==null||de.call(window,o("user.toastSecretResetSuccess"),"success"),await G(w,Y,K)}catch(gt){(Ce=window.showToast)==null||Ce.call(window,gt instanceof Error?gt.message:o("user.toastSecretResetFailed"),"error")}}})}function Yn(y){var ue;N(null),(ue=window.showConfirm)==null||ue.call(window,{message:o("user.confirmDelete"),onConfirm:async()=>{var de,Ce;try{await T1(y.id),(de=window.showToast)==null||de.call(window,o("user.toastDeletedSuccess"),"success"),await G(w,Y,K)}catch(gt){(Ce=window.showToast)==null||Ce.call(window,gt instanceof Error?gt.message:o("user.toastDeletedFailed"),"error")}}})}function an(y){var de;N(null);const ue=y.subscribe_url;if(!ue){(de=window.showToast)==null||de.call(window,o("user.toastNoSubscribeUrl"),"error");return}Ct({url:ue,userId:y.id})}function L(y){N(null),s.push(`/order?user_id=${y.id}`)}function ce(y){N(null),s.push(`/subscription?user_id=${y.id}`)}function se(y){N(null),C("invite_user_id"),P(String(y.id)),G(1,String(y.id),"invite_user_id")}async function Re(y,ue){pn(!0),be("");try{const de=await H1(y,ue,Gt);Pt(de.data||[]),ye(de.total||0),Ut(ue)}catch(de){be(de instanceof Error?de.message:o("user.historyLoading"))}finally{pn(!1)}}function Ve(y){N(null),tn(y),Re(y.id,1)}function et(y){N(null),ke(y.email),Ue({plan_id:"",period:"month_price",total_amount:""})}async function ht(y){var ue,de;if(y.preventDefault(),!!me){Ge(!0);try{await bx({email:me,plan_id:Number(Se.plan_id),period:Se.period,total_amount:(Number(Se.total_amount)||0)*100}),(ue=window.showToast)==null||ue.call(window,o("user.toastAssignSuccess"),"success"),ke(null)}catch(Ce){(de=window.showToast)==null||de.call(window,Ce instanceof Error?Ce.message:o("user.toastAssignFailed"),"error")}finally{Ge(!1)}}}function ct(y){N(null),te(y),re({id:y.id,email:y.email,invite_user_email:"",password:"",balance:y.balance,commission_balance:y.commission_balance,u:xd(y.u),d:xd(y.d),transfer_enable:xd(y.transfer_enable),device_limit:y.device_limit,network_settings:y.network_settings??"",expired_at:Rj(y.expired_at),plan_id:y.plan_id,banned:y.banned,commission_type:y.commission_type??0,commission_rate:y.commission_rate??"",discount:y.discount??"",speed_limit:y.speed_limit,is_admin:y.is_admin,is_staff:y.is_staff,remarks:y.remarks??""})}function Ae(y,ue){re(de=>({...de,[y]:ue}))}async function Hn(y){var ue,de;if(y.preventDefault(),!!R){J(!0);try{const Ce={id:R.id,email:M.email,plan_id:M.plan_id||null,expired_at:Ah(String(M.expired_at??"")),transfer_enable:gd(Number(M.transfer_enable??0)),speed_limit:M.speed_limit||null,device_limit:M.device_limit||null,u:gd(Number(M.u??0)),d:gd(Number(M.d??0)),balance:Number(M.balance??0),commission_balance:Number(M.commission_balance??0),commission_rate:M.commission_rate!==""&&M.commission_rate!==null?Number(M.commission_rate):null,commission_type:Number(M.commission_type??0),discount:M.discount!==""&&M.discount!==null?Number(M.discount):null,network_settings:M.network_settings||null,remarks:M.remarks||null,is_admin:Number(M.is_admin??0),is_staff:Number(M.is_staff??0),banned:Number(M.banned??0)};M.invite_user_email&&(Ce.invite_user_email=M.invite_user_email),M.password&&(Ce.password=M.password),await z1(Ce),(ue=window.showToast)==null||ue.call(window,o("user.toastSaveSuccess"),"success"),te(null),await G(w,Y,K)}catch(Ce){(de=window.showToast)==null||de.call(window,Ce instanceof Error?Ce.message:o("user.toastSaveFailed"),"error")}finally{J(!1)}}}async function ci(y){var ue,de;y.preventDefault(),pe(!0);try{await E1({email_prefix:H.email_prefix,email_suffix:H.email_suffix,password:H.password||void 0,plan_id:H.plan_id?Number(H.plan_id):void 0,expired_at:Ah(H.expired_at)}),(ue=window.showToast)==null||ue.call(window,o("user.toastCreateSuccess"),"success"),W(!1),S({email_prefix:"",email_suffix:"gmail.com",password:"",plan_id:"",expired_at:""}),await G(w,Y,K)}catch(Ce){(de=window.showToast)==null||de.call(window,Ce instanceof Error?Ce.message:o("user.toastCreateFailed"),"error")}finally{pe(!1)}}const Sn=Math.ceil(g/15),fs=bd(K);return t.jsxs(Qt,{title:o("user.title"),subtitle:o("user.subtitle"),children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("div",{className:"toolbar-row",children:[t.jsxs("div",{children:[t.jsx("h2",{children:o("user.heading")}),t.jsxs("p",{children:[g," ",o("user.totalUsers")]})]}),t.jsxs("div",{className:"button-row",children:[t.jsxs("div",{className:"col-picker-wrap",ref:ne,children:[t.jsxs("button",{className:"ghost-button",type:"button",onClick:()=>$(!E),children:[t.jsx(hv,{size:16}),o("user.columns")]}),E?t.jsxs("div",{className:"col-picker-dropdown",children:[t.jsx("div",{className:"col-picker-header",children:t.jsx("span",{children:o("user.visibleColumns",{count:rt})})}),Ud.map(y=>t.jsxs("label",{className:"col-picker-item",children:[t.jsx("input",{type:"checkbox",checked:ie.has(y.key),onChange:()=>qe(y.key)}),t.jsx("span",{children:Wt(y.key,o)})]},y.key))]}):null]}),t.jsxs("button",{className:"ghost-button",type:"button",onClick:()=>void G(w,Y,K),disabled:B,children:[t.jsx(kt,{size:16}),o("common.refresh")]}),t.jsxs("button",{className:"primary-button",type:"button",onClick:()=>W(!0),children:[t.jsx(Nn,{size:16}),o("user.createUser")]})]})]}),t.jsxs("div",{className:"filter-bar",children:[t.jsx("select",{className:"config-input filter-select",value:K,onChange:y=>C(y.target.value),children:Yo.map(y=>t.jsx("option",{value:y.value,children:Bj(y.value,o)},y.value))}),t.jsxs("div",{className:"search-input-wrap",children:[t.jsx(Xo,{size:16}),t.jsx("input",{className:"config-input search-input",value:Y,onChange:y=>P(y.target.value),placeholder:fs.placeholder,onKeyDown:y=>y.key==="Enter"&&we()})]}),t.jsxs("button",{className:"ghost-button",type:"button",onClick:we,children:[t.jsx(ds,{size:16}),o("user.filter")]}),Y?t.jsxs("button",{className:"ghost-button",type:"button",onClick:Ee,children:[t.jsx(ot,{size:16}),o("user.clearFilter")]}):null]}),O?t.jsx("div",{className:"form-error",children:O}):null,B&&d.length===0?t.jsx(vt,{label:o("user.loading")}):null,t.jsxs("div",{className:`content-loading-container ${B?"is-loading":""}`,children:[t.jsx("div",{className:"page-loading-bar"}),t.jsxs("div",{className:"mobile-user-list",children:[d.map(y=>{const ue=Uo(y.u+y.d),de=Uo(y.transfer_enable),Ce=parseFloat(ue);return t.jsxs("div",{className:"mobile-user-card",children:[t.jsxs("div",{className:"mobile-user-card-header",children:[t.jsxs("div",{className:"user-id-email",children:[t.jsxs("span",{className:"user-id",children:["#",y.id]}),t.jsx("span",{className:"user-email",title:y.email,children:y.email})]}),y.banned?t.jsx("span",{className:"status-tag banned",children:o("user.cardBanned")}):t.jsx("span",{className:"status-tag normal",children:o("user.cardActive")})]}),t.jsxs("div",{className:"mobile-user-card-body",children:[t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:o("user.planGroupLabel")}),t.jsxs("span",{className:"info-val",children:[Ke(y)," / ",y.is_admin?t.jsx("span",{style:{fontWeight:600},children:o("user.adminLabel")}):Ye(y)]})]}),t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:o("user.trafficUsedLimitLabel")}),t.jsxs("span",{className:"info-val",children:[t.jsxs("span",{className:`traffic-used ${Ce>0?Ce>parseFloat(de)*.9?"high":"ok":""}`,children:[ue," GB"]})," / ",de," GB"]})]}),t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:Wt("devices",o)}),t.jsx("span",{className:"info-val",children:Wa(y,"right")})]}),t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:Wt("expires",o)}),t.jsx("span",{className:"info-val",children:y.expired_at?t.jsx("span",{className:`expiry-date ${y.expired_at<Date.now()/1e3?"expired":""}`,children:Ao(y.expired_at)}):t.jsx("span",{className:"expiry-none",children:"—"})})]}),t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:o("user.balanceCommLabel")}),t.jsxs("span",{className:"info-val",children:[(y.balance/100).toFixed(2)," ₫ / ",(y.commission_balance/100).toFixed(2)," ₫"]})]}),t.jsxs("div",{className:"info-row",children:[t.jsx("span",{className:"info-label",children:Wt("joined",o)}),t.jsx("span",{className:"info-val",children:t.jsx("small",{children:Ao(y.created_at)})})]})]}),t.jsx("div",{className:"mobile-user-card-actions",children:t.jsxs("div",{className:`action-dropdown-wrap ${xe===y.id?"active":""}`,children:[t.jsxs("button",{className:"action-dropdown-btn",type:"button",onClick:()=>N(xe===y.id?null:y.id),children:[o("user.colActions")," ",t.jsx(gl,{size:14})]}),xe===y.id?t.jsx("div",{className:"mobile-action-sheet-backdrop",onClick:()=>N(null),children:t.jsxs("div",{className:"mobile-action-sheet",onClick:gt=>gt.stopPropagation(),children:[t.jsxs("div",{className:"mobile-action-sheet-head",children:[t.jsxs("div",{children:[t.jsx("strong",{children:y.email}),t.jsxs("small",{children:["#",y.id]})]}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>N(null),children:t.jsx(ot,{size:16})})]}),t.jsxs("div",{className:"action-dropdown-menu mobile-action-menu",children:[t.jsxs("button",{type:"button",onClick:()=>ct(y),children:[t.jsx(Bt,{size:14}),o("user.actionEdit")]}),t.jsxs("button",{type:"button",onClick:()=>et(y),children:[t.jsx(ch,{size:14}),o("user.actionAssignOrder")]}),t.jsxs("button",{type:"button",onClick:()=>void Gn(y),children:[t.jsx(jn,{size:14}),o("user.actionCopyUrl")]}),t.jsxs("button",{type:"button",onClick:()=>an(y),children:[t.jsx(oh,{size:14}),o("user.actionGetQr")]}),t.jsxs("button",{type:"button",onClick:()=>mn(y),children:[t.jsx(Bo,{size:14}),o("user.actionResetSecret")]}),t.jsxs("button",{type:"button",onClick:()=>L(y),children:[t.jsx(ih,{size:14}),o("user.actionOrders")]}),t.jsxs("button",{type:"button",onClick:()=>ce(y),children:[t.jsx(Cd,{size:14}),o("user.actionSubscriptions")]}),t.jsxs("button",{type:"button",onClick:()=>se(y),children:[t.jsx(us,{size:14}),o("user.actionInvitedUsers")]}),t.jsxs("button",{type:"button",onClick:()=>Ve(y),children:[t.jsx(rd,{size:14}),o("user.actionDataHistory")]}),t.jsx("div",{className:"menu-divider"}),t.jsxs("button",{type:"button",className:"danger-item",onClick:()=>Yn(y),children:[t.jsx($t,{size:14}),o("user.actionDelete")]})]})]})}):null]})})]},y.id)}),!B&&d.length===0?t.jsx("div",{className:"empty-state",children:o("user.noUsers")}):null]}),t.jsx("section",{className:"panel table-panel hide-on-mobile",children:t.jsx("div",{className:"admin-table-wrap",children:t.jsxs("table",{className:"admin-table user-table",children:[t.jsx("thead",{children:t.jsxs("tr",{children:[ve("id")&&t.jsx("th",{children:Wt("id",o)}),ve("email")&&t.jsx("th",{children:Wt("email",o)}),ve("status")&&t.jsx("th",{children:Wt("status",o)}),ve("plan")&&t.jsx("th",{children:Wt("plan",o)}),ve("group")&&t.jsx("th",{children:Wt("group",o)}),ve("used")&&t.jsx("th",{children:Wt("used",o)}),ve("traffic")&&t.jsx("th",{children:Wt("traffic",o)}),ve("devices")&&t.jsx("th",{children:Wt("devices",o)}),ve("expires")&&t.jsx("th",{children:Wt("expires",o)}),ve("balance")&&t.jsx("th",{children:Wt("balance",o)}),ve("commission")&&t.jsx("th",{children:Wt("commission",o)}),ve("joined")&&t.jsx("th",{children:Wt("joined",o)}),ve("actions")&&t.jsx("th",{children:Wt("actions",o)})]})}),t.jsxs("tbody",{children:[d.map(y=>{const ue=Uo(y.u+y.d),de=Uo(y.transfer_enable),Ce=parseFloat(ue);return t.jsxs("tr",{children:[ve("id")&&t.jsx("td",{children:y.id}),ve("email")&&t.jsx("td",{children:t.jsx("span",{className:"email-link",children:y.email})}),ve("status")&&t.jsx("td",{children:y.banned?t.jsx("span",{className:"status-tag banned",children:o("user.cardBanned")}):t.jsx("span",{className:"status-tag normal",children:o("user.cardActive")})}),ve("plan")&&t.jsx("td",{children:Ke(y)}),ve("group")&&t.jsx("td",{children:y.is_admin?t.jsx("span",{style:{fontWeight:600},children:o("user.adminLabel")}):Ye(y)}),ve("used")&&t.jsx("td",{children:t.jsx("span",{className:`traffic-used ${Ce>0?Ce>parseFloat(de)*.9?"high":"ok":""}`,children:ue})}),ve("traffic")&&t.jsx("td",{children:de}),ve("devices")&&t.jsx("td",{children:Wa(y)}),ve("expires")&&t.jsx("td",{children:y.expired_at?t.jsx("span",{className:`expiry-date ${y.expired_at<Date.now()/1e3?"expired":""}`,children:Ao(y.expired_at)}):t.jsx("span",{className:"expiry-none",children:"—"})}),ve("balance")&&t.jsx("td",{children:(y.balance/100).toFixed(2)}),ve("commission")&&t.jsx("td",{children:(y.commission_balance/100).toFixed(2)}),ve("joined")&&t.jsx("td",{children:t.jsx("small",{children:Ao(y.created_at)})}),ve("actions")&&t.jsx("td",{children:t.jsxs("div",{className:`action-dropdown-wrap ${xe===y.id?"active":""}`,children:[t.jsxs("button",{className:"action-dropdown-btn",type:"button",onClick:()=>N(xe===y.id?null:y.id),children:[o("user.colActions")," ",t.jsx(gl,{size:14})]}),xe===y.id?t.jsxs("div",{className:"action-dropdown-menu",children:[t.jsxs("button",{type:"button",onClick:()=>ct(y),children:[t.jsx(Bt,{size:14}),o("user.actionEdit")]}),t.jsxs("button",{type:"button",onClick:()=>et(y),children:[t.jsx(ch,{size:14}),o("user.actionAssignOrder")]}),t.jsxs("button",{type:"button",onClick:()=>void Gn(y),children:[t.jsx(jn,{size:14}),o("user.actionCopyUrl")]}),t.jsxs("button",{type:"button",onClick:()=>an(y),children:[t.jsx(oh,{size:14}),o("user.actionGetQr")]}),t.jsxs("button",{type:"button",onClick:()=>mn(y),children:[t.jsx(Bo,{size:14}),o("user.actionResetSecret")]}),t.jsxs("button",{type:"button",onClick:()=>L(y),children:[t.jsx(ih,{size:14}),o("user.actionOrders")]}),t.jsxs("button",{type:"button",onClick:()=>ce(y),children:[t.jsx(Cd,{size:14}),o("user.actionSubscriptions")]}),t.jsxs("button",{type:"button",onClick:()=>se(y),children:[t.jsx(us,{size:14}),o("user.actionInvitedUsers")]}),t.jsxs("button",{type:"button",onClick:()=>Ve(y),children:[t.jsx(rd,{size:14}),o("user.actionDataHistory")]}),t.jsx("div",{className:"menu-divider"}),t.jsxs("button",{type:"button",className:"danger-item",onClick:()=>Yn(y),children:[t.jsx($t,{size:14}),o("user.actionDelete")]})]}):null]})})]},y.id)}),!B&&d.length===0?t.jsx("tr",{children:t.jsx("td",{colSpan:rt,children:t.jsx("div",{className:"empty-state",children:o("user.noUsers")})})}):null]})]})})}),Sn>1?t.jsx("div",{className:"pagination-wrap",children:t.jsxs("div",{className:"pagination",children:[t.jsx("button",{className:"mini-button",disabled:w<=1,onClick:()=>Ie(w-1),children:t.jsx(ga,{size:16})}),Array.from({length:Math.min(5,Sn)},(y,ue)=>{let de;return Sn<=5||w<=3?de=ue+1:w>=Sn-2?de=Sn-4+ue:de=w-2+ue,t.jsx("button",{className:`mini-button ${de===w?"active-page":""}`,onClick:()=>Ie(de),children:de},de)}),Sn>5?t.jsxs("span",{className:"page-info",children:["… ",Sn]}):null,t.jsx("button",{className:"mini-button",disabled:w>=Sn,onClick:()=>Ie(w+1),children:t.jsx(ba,{size:16})})]})}):null]}),R?t.jsx("div",{className:"modal-backdrop",onClick:()=>te(null),children:t.jsxs("section",{className:"modal-panel edit-user-modal",onClick:y=>y.stopPropagation(),children:[t.jsxs("div",{className:"modal-heading",children:[t.jsx("h2",{children:o("user.editUser")}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>te(null),children:t.jsx(ot,{size:18})})]}),t.jsxs("form",{className:"modal-body-scroll",onSubmit:Hn,children:[t.jsxs("label",{className:"field-label",children:[o("user.email"),t.jsx("input",{className:"config-input",type:"email",required:!0,value:String(M.email??""),onChange:y=>Ae("email",y.target.value)})]}),t.jsxs("label",{className:"field-label",children:[o("user.inviterEmailLabel"),t.jsx("input",{className:"config-input",type:"email",value:String(M.invite_user_email??""),onChange:y=>Ae("invite_user_email",y.target.value),placeholder:o("user.inviterEmailLabel")})]}),t.jsxs("label",{className:"field-label",children:[o("user.password"),t.jsx("input",{className:"config-input",type:"password",value:String(M.password??""),onChange:y=>Ae("password",y.target.value),placeholder:o("user.passwordPlaceholder"),minLength:8})]}),t.jsxs("div",{className:"form-row-2",children:[t.jsxs("label",{className:"field-label",children:[o("user.balance"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",step:"0.01",value:String((Number(M.balance??0)/100).toFixed(2)),onChange:y=>Ae("balance",Math.round(Number(y.target.value)*100))}),t.jsx("span",{className:"input-suffix",children:"₫"})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.commissionBalance"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",step:"0.01",value:String((Number(M.commission_balance??0)/100).toFixed(2)),onChange:y=>Ae("commission_balance",Math.round(Number(y.target.value)*100))}),t.jsx("span",{className:"input-suffix",children:"₫"})]})]})]}),t.jsxs("div",{className:"form-row-2",children:[t.jsxs("label",{className:"field-label",children:[o("user.uploadLabel"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(M.u??0),onChange:y=>Ae("u",y.target.value)}),t.jsx("span",{className:"input-suffix",children:"GB"})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.downloadLabel"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(M.d??0),onChange:y=>Ae("d",y.target.value)}),t.jsx("span",{className:"input-suffix",children:"GB"})]})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.transferEnable"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(M.transfer_enable??0),onChange:y=>Ae("transfer_enable",y.target.value)}),t.jsx("span",{className:"input-suffix",children:"GB"})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.deviceLimit"),t.jsx("input",{className:"config-input",type:"number",min:"0",value:String(M.device_limit??""),onChange:y=>Ae("device_limit",y.target.value?Number(y.target.value):null),placeholder:o("user.deviceLimitPlaceholder")})]}),t.jsxs("label",{className:"field-label",children:[o("user.sniUserLabel"),t.jsx("input",{className:"config-input",value:String(M.network_settings??""),onChange:y=>Ae("network_settings",y.target.value),placeholder:o("user.sniUserPlaceholder")})]}),t.jsxs("label",{className:"field-label",children:[o("user.expiredAt"),t.jsx("input",{className:"config-input",type:"date",value:String(M.expired_at??""),onChange:y=>Ae("expired_at",y.target.value),onClick:y=>{var ue,de;return(de=(ue=y.currentTarget).showPicker)==null?void 0:de.call(ue)},onFocus:y=>{var ue,de;return(de=(ue=y.currentTarget).showPicker)==null?void 0:de.call(ue)}})]}),t.jsxs("label",{className:"field-label",children:[o("user.plan"),t.jsxs("select",{className:"config-input",value:String(M.plan_id??""),onChange:y=>Ae("plan_id",y.target.value?Number(y.target.value):null),children:[t.jsx("option",{value:"",children:o("user.planNone")}),h.map(y=>t.jsx("option",{value:y.id,children:y.name},y.id))]})]}),t.jsxs("label",{className:"field-label",children:[o("user.accountStatusLabel"),t.jsxs("select",{className:"config-input",value:String(M.banned??0),onChange:y=>Ae("banned",Number(y.target.value)),children:[t.jsx("option",{value:"0",children:o("user.cardActive")}),t.jsx("option",{value:"1",children:o("user.cardBanned")})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.commissionTypeLabel"),t.jsxs("select",{className:"config-input",value:String(M.commission_type??0),onChange:y=>Ae("commission_type",Number(y.target.value)),children:[t.jsx("option",{value:"0",children:o("user.commissionTypeSystem")}),t.jsx("option",{value:"1",children:o("user.commissionTypeFixed")}),t.jsx("option",{value:"2",children:o("user.commissionTypePercent")})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.commissionRate"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",min:"0",max:"100",value:String(M.commission_rate??""),onChange:y=>Ae("commission_rate",y.target.value),placeholder:o("user.commissionRatePlaceholder")}),t.jsx("span",{className:"input-suffix",children:"%"})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.discount"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",min:"0",max:"100",value:String(M.discount??""),onChange:y=>Ae("discount",y.target.value),placeholder:o("user.exclusiveDiscountPlaceholder")}),t.jsx("span",{className:"input-suffix",children:"%"})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.speedLimit"),t.jsxs("div",{className:"input-with-suffix",children:[t.jsx("input",{className:"config-input",type:"number",min:"0",value:String(M.speed_limit??""),onChange:y=>Ae("speed_limit",y.target.value?Number(y.target.value):null),placeholder:o("user.speedLimitPlaceholder")}),t.jsx("span",{className:"input-suffix",children:"Mbps"})]})]}),t.jsxs("div",{className:"toggle-field",children:[t.jsx("span",{className:"field-label-text",children:o("user.adminLabel")}),t.jsx("button",{type:"button",className:`admin-switch ${M.is_admin?"active":""}`,onClick:()=>Ae("is_admin",M.is_admin?0:1),children:t.jsx("span",{className:"admin-switch-thumb"})})]}),t.jsxs("div",{className:"toggle-field",children:[t.jsx("span",{className:"field-label-text",children:o("user.staffLabel")}),t.jsx("button",{type:"button",className:`admin-switch ${M.is_staff?"active":""}`,onClick:()=>Ae("is_staff",M.is_staff?0:1),children:t.jsx("span",{className:"admin-switch-thumb"})})]}),t.jsxs("label",{className:"field-label",children:[o("user.remarks"),t.jsx("textarea",{className:"config-input",rows:3,value:String(M.remarks??""),onChange:y=>Ae("remarks",y.target.value),placeholder:o("user.remarksPlaceholder")})]}),t.jsxs("div",{className:"modal-footer",children:[t.jsx("button",{className:"ghost-button",type:"button",onClick:()=>te(null),children:o("common.cancel")}),t.jsx("button",{className:"primary-button",type:"submit",disabled:A,children:o(A?"common.processing":"common.save")})]})]})]})}):null,x?t.jsx("div",{className:"modal-backdrop",onClick:()=>W(!1),children:t.jsxs("section",{className:"modal-panel compact-modal",onClick:y=>y.stopPropagation(),children:[t.jsxs("div",{className:"modal-heading",children:[t.jsx("h2",{children:o("user.createUser")}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>W(!1),children:t.jsx(ot,{size:18})})]}),t.jsxs("form",{className:"modal-form",onSubmit:ci,children:[t.jsxs("label",{className:"field-label",children:[o("user.email"),t.jsxs("div",{className:"email-compose",children:[t.jsx("input",{className:"config-input",required:!0,value:H.email_prefix,onChange:y=>S({...H,email_prefix:y.target.value}),placeholder:o("user.emailPrefix")}),t.jsx("span",{className:"email-at",children:"@"}),t.jsx("input",{className:"config-input",required:!0,value:H.email_suffix,onChange:y=>S({...H,email_suffix:y.target.value}),placeholder:o("user.emailSuffix")})]})]}),t.jsxs("label",{className:"field-label",children:[o("user.password"),t.jsx("input",{className:"config-input",type:"password",value:H.password,onChange:y=>S({...H,password:y.target.value}),placeholder:o("user.createPasswordPlaceholder"),minLength:8})]}),t.jsxs("label",{className:"field-label",children:[o("user.plan"),t.jsxs("select",{className:"config-input",value:H.plan_id,onChange:y=>S({...H,plan_id:y.target.value}),children:[t.jsx("option",{value:"",children:o("user.planNone")}),h.map(y=>t.jsx("option",{value:y.id,children:y.name},y.id))]})]}),t.jsxs("label",{className:"field-label",children:[o("user.expiredAt"),t.jsx("input",{className:"config-input",type:"date",value:H.expired_at,onChange:y=>S({...H,expired_at:y.target.value}),onClick:y=>{var ue,de;return(de=(ue=y.currentTarget).showPicker)==null?void 0:de.call(ue)},onFocus:y=>{var ue,de;return(de=(ue=y.currentTarget).showPicker)==null?void 0:de.call(ue)}})]}),t.jsxs("div",{className:"modal-actions",children:[t.jsx("button",{className:"ghost-button",type:"button",onClick:()=>W(!1),children:o("common.cancel")}),t.jsx("button",{className:"primary-button",type:"submit",disabled:X,children:o(X?"user.creating":"user.createUser")})]})]})]})}):null,me?t.jsx("div",{className:"modal-backdrop",onClick:()=>ke(null),children:t.jsxs("section",{className:"modal-panel compact-modal",onClick:y=>y.stopPropagation(),children:[t.jsxs("div",{className:"modal-heading",children:[t.jsx("h2",{children:o("user.assignOrderTitle")}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>ke(null),children:t.jsx(ot,{size:18})})]}),t.jsxs("form",{className:"modal-form",onSubmit:ht,children:[t.jsxs("label",{className:"field-label",children:[o("user.email"),t.jsx("input",{className:"config-input",type:"email",readOnly:!0,value:me})]}),t.jsxs("label",{className:"field-label",children:[o("user.plan"),t.jsxs("select",{className:"config-input",required:!0,value:Se.plan_id,onChange:y=>Ue({...Se,plan_id:y.target.value}),children:[t.jsx("option",{value:"",children:o("user.assignPlanSelect")}),h.map(y=>t.jsx("option",{value:y.id,children:y.name},y.id))]})]}),t.jsxs("label",{className:"field-label",children:[o("user.assignPeriodLabel"),t.jsx("select",{className:"config-input",value:Se.period,onChange:y=>Ue({...Se,period:y.target.value}),children:qj.map(y=>t.jsx("option",{value:y.value,children:Gj(y.value,o)},y.value))})]}),t.jsxs("label",{className:"field-label",children:[o("user.assignTotalAmountLabel"),t.jsx("input",{className:"config-input",type:"number",min:"0",step:"0.01",value:Se.total_amount,onChange:y=>Ue({...Se,total_amount:y.target.value}),placeholder:"0"})]}),t.jsxs("div",{className:"modal-actions",children:[t.jsx("button",{className:"ghost-button",type:"button",onClick:()=>ke(null),children:o("common.cancel")}),t.jsx("button",{className:"primary-button",type:"submit",disabled:lt,children:o(lt?"common.processing":"common.save")})]})]})]})}):null,t.jsx("style",{dangerouslySetInnerHTML:{__html:`
        /* ── column picker ─────────────────────── */
        .col-picker-wrap {
          position: relative;
          display: inline-block;
      ...
      `}}),We?t.jsx("div",{className:"modal-backdrop",onClick:()=>Ct(null),children:t.jsxs("section",{className:"modal-panel qr-modal",onClick:y=>y.stopPropagation(),children:[t.jsxs("div",{className:"modal-heading",children:[t.jsx("h2",{children:o("user.qrCodeTitle")}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>Ct(null),children:t.jsx(ot,{size:18})})]}),t.jsxs("div",{className:"qr-body",children:[t.jsx("img",{src:`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(We.url)}`,alt:o("user.actionGetQr"),width:200,height:200}),t.jsx("div",{className:"qr-url",children:o("user.qrCodeUserId",{userId:We.userId})})]})]})}):null,wt?t.jsx("div",{className:"modal-backdrop",onClick:()=>tn(null),children:t.jsxs("section",{className:"modal-panel history-modal",onClick:y=>y.stopPropagation(),children:[t.jsxs("div",{className:"modal-heading",children:[t.jsxs("div",{children:[t.jsx("h2",{style:{fontSize:"1.25rem",fontWeight:"600"},children:o("user.dataHistoryTitle")}),t.jsx("p",{style:{fontSize:"0.85rem",color:"var(--muted)",marginTop:"2px"},children:o("user.dataHistorySub",{email:wt.email,id:wt.id})})]}),t.jsx("button",{className:"icon-button",type:"button",onClick:()=>tn(null),children:t.jsx(ot,{size:18})})]}),t.jsxs("div",{className:"modal-body",style:{padding:"20px"},children:[T?t.jsx("div",{className:"form-error",style:{marginBottom:"16px"},children:T}):null,t.jsxs("div",{className:"history-summary-grid",children:[t.jsxs("div",{className:"summary-card",children:[t.jsx("div",{className:"summary-card-title",children:o("user.historyLogCount")}),t.jsx("div",{className:"summary-card-value",children:o("user.historyTotalDays",{count:At})})]}),t.jsxs("div",{className:"summary-card",children:[t.jsx("div",{className:"summary-card-title",children:o("user.historyTotalUpload")}),t.jsx("div",{className:"summary-card-value highlight",children:ii(mt.reduce((y,ue)=>y+ue.u,0))})]}),t.jsxs("div",{className:"summary-card",children:[t.jsx("div",{className:"summary-card-title",children:o("user.historyTotalDownload")}),t.jsx("div",{className:"summary-card-value highlight",children:ii(mt.reduce((y,ue)=>y+ue.d,0))})]}),t.jsxs("div",{className:"summary-card",children:[t.jsx("div",{className:"summary-card-title",children:o("user.historyCombinedUsage")}),t.jsx("div",{className:"summary-card-value highlight",children:ii(mt.reduce((y,ue)=>y+ue.u+ue.d,0))})]})]}),zt?t.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",minHeight:"200px"},children:t.jsx(vt,{label:o("user.historyLoading")})}):mt.length===0?t.jsxs("div",{style:{textAlign:"center",padding:"48px 16px",background:"var(--surface-soft)",borderRadius:"8px",border:"1px dashed var(--line)",color:"var(--muted)"},children:[t.jsx(rd,{size:36,style:{margin:"0 auto 12px",opacity:.5}}),t.jsx("p",{style:{fontWeight:500},children:o("user.historyNoHistory")}),t.jsx("p",{style:{fontSize:"0.8rem",marginTop:"4px"},children:o("user.historyNoHistoryHelp")})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"admin-table-wrap",style:{border:"1px solid var(--line)",borderRadius:"8px",overflow:"hidden",marginBottom:"16px"},children:t.jsxs("table",{className:"admin-table",style:{width:"100%"},children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{children:o("user.historyColDate")}),t.jsx("th",{children:o("user.historyColRate")}),t.jsx("th",{children:o("user.historyColUpload")}),t.jsx("th",{children:o("user.historyColDownload")}),t.jsx("th",{children:o("user.historyColTotal")})]})}),t.jsx("tbody",{children:mt.map(y=>{const ue=ii(y.u),de=ii(y.d),Ce=ii(y.u+y.d);return t.jsxs("tr",{children:[t.jsx("td",{style:{fontWeight:500},children:Hj(y.record_at)}),t.jsx("td",{children:t.jsxs("span",{style:{background:"var(--surface-soft)",border:"1px solid var(--line)",padding:"2px 6px",borderRadius:"4px",fontSize:"0.75rem",fontFamily:"monospace",fontWeight:600},children:[Number(y.server_rate).toFixed(1),"x"]})}),t.jsx("td",{style:{color:"var(--muted)"},children:ue}),t.jsx("td",{style:{color:"var(--muted)"},children:de}),t.jsx("td",{style:{fontWeight:600,color:"var(--foreground)"},children:Ce})]},y.id)})})]})}),t.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:"16px",paddingTop:"12px",borderTop:"1px solid var(--line)"},children:[t.jsx("span",{style:{fontSize:"0.8rem",color:"var(--muted)"},children:o("user.historyShowingLogs",{start:Math.min((Me-1)*Gt+1,At),end:Math.min(Me*Gt,At),total:At})}),t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsxs("button",{className:"ghost-button",type:"button",disabled:Me<=1,onClick:()=>Re(wt.id,Me-1),children:[t.jsx(ga,{size:16}),o("user.historyPrev")]}),t.jsxs("button",{className:"ghost-button",type:"button",disabled:Me*Gt>=At,onClick:()=>Re(wt.id,Me+1),children:[o("user.historyNext"),t.jsx(ba,{size:16})]})]})]})]})]})]})}):null]})}const Uh=15,Rh=20,$j=["email","id","user_id","plan_id","status"];function $a(s,i){return s?new Date(s*1e3).toLocaleString():i}function Qj(s){if(!s)return"";const i=new Date(s*1e3),o=d=>String(d).padStart(2,"0");return`${i.getFullYear()}-${o(i.getMonth()+1)}-${o(i.getDate())}`}function Xj(s){return s?Math.floor(new Date(s).getTime()/1e3):null}function hl(s){return+(s/1073741824).toFixed(2)}function yd(s){return Math.round((Number(s)||0)*1073741824)}function Zj(s){return s==="email"?"like":"="}function Kj(s,i){switch(s){case"email":return i("subscription.filterEmail");case"id":return i("subscription.filterId");case"user_id":return i("subscription.filterUserId");case"plan_id":return i("subscription.filterPlanId");case"status":return i("subscription.filterStatus");default:return s}}function Hh(s,i){return i(s==="active"?"subscription.statusActive":"subscription.statusDisabled")}function Lh(s,i){switch(s){case"bound":return i("subscription.slotStatusBound");case"banned":return i("subscription.slotStatusBanned");default:return i("subscription.slotStatusPending")}}function qh(s){switch(s){case"bound":return"enabled";case"banned":return"status-cancelled";default:return"status-pending"}}function Vj(s){return s.transfer_enable?Math.min(100,Math.round(s.total_used/s.transfer_enable*100)):0}function Jj(){const s=Dt(),i=Wn(),{t:o}=Ze(),[d,p]=f.useState([]),[h,m]=f.useState(0),[_,j]=f.useState(1),[g,v]=f.useState("email"),[w,z]=f.useState(""),[Y,P]=f.useState(!0),[K,C]=f.useState(""),[B,U]=f.useState(null),[O,ee]=f.useState({}),[ie,oe]=f.useState(null),[E,$]=f.useState(null),[ne,xe]=f.useState([]),[N,R]=f.useState(0),[te,M]=f.useState(1),[re,A]=f.useState(!1),[J,x]=f.useState(""),[W,H]=f.useState(null);function S(T){const be=T==null?void 0:T.trim();be&&s.push(`/user?email=${encodeURIComponent(be)}`)}const X=f.useCallback(async(T=1,be="",qe="email")=>{P(!0),C("");try{const ve=be.trim()?[{key:qe,condition:Zj(qe),value:be.trim()}]:void 0,rt=await D1(T,Uh,ve);p(rt.data),m(rt.total),j(T)}catch(ve){C(ve instanceof Error?ve.message:o("subscription.loadFailed"))}finally{P(!1)}},[o]),pe=f.useCallback(async(T,be=1)=>{A(!0),x("");try{const qe=await jx(be,Rh,[{key:"subscription_id",condition:"=",value:String(T.id)}]);xe(qe.data),R(qe.total),M(be)}catch(qe){x(qe instanceof Error?qe.message:o("subscription.slotsLoadFailed"))}finally{A(!1)}},[o]);f.useEffect(()=>{if(!Ot()){s.replace("/login");return}const T=new URLSearchParams(i.search),qe=[["user_id",T.get("user_id")],["id",T.get("id")],["plan_id",T.get("plan_id")],["email",T.get("email")],["status",T.get("status")]].find(([,ve])=>ve&&ve.trim());if(qe){const[ve,rt]=qe,G=rt??"";v(ve),z(G),X(1,G,ve);return}X()},[X,i.search,s]);function me(T){T.preventDefault(),X(1,w,g)}function ke(){if(z(""),i.search){s.replace("/subscription");return}X(1,"",g)}function Se(T){U(T),ee({transfer_enable:String(hl(T.transfer_enable)),u:String(hl(T.u)),d:String(hl(T.d)),device_limit:T.device_limit===null?"":String(T.device_limit),speed_limit:T.speed_limit===null?"":String(T.speed_limit),expired_at:Qj(T.expired_at),status:T.status,auto_renewal:String(T.auto_renewal||0),remarks:T.remarks??""})}async function Ue(T){var be,qe;if(T.preventDefault(),!!B){oe(B.id);try{await A1({id:B.id,transfer_enable:yd(O.transfer_enable),u:yd(O.u),d:yd(O.d),device_limit:O.device_limit===""?null:Number(O.device_limit),speed_limit:O.speed_limit===""?null:Number(O.speed_limit),expired_at:Xj(O.expired_at),status:O.status,auto_renewal:Number(O.auto_renewal),remarks:O.remarks}),U(null),(be=window.showToast)==null||be.call(window,o("subscription.updateSuccess"),"success"),await X(_,w,g)}catch(ve){(qe=window.showToast)==null||qe.call(window,ve instanceof Error?ve.message:o("subscription.saveFailed"),"error")}finally{oe(null)}}}function lt(T){var be;(be=window.showConfirm)==null||be.call(window,{message:o("subscription.resetConfirm",{id:T.id}),onConfirm:async()=>{var qe,ve;oe(T.id);try{await U1(T.id),(qe=window.showToast)==null||qe.call(window,o("subscription.resetSuccess"),"success"),await X(_,w,g)}catch(rt){(ve=window.showToast)==null||ve.call(window,rt instanceof Error?rt.message:o("subscription.resetFailed"),"error")}finally{oe(null)}}})}async function Ge(T){var qe;if(!T)return;const be=await Va(T);(qe=window.showToast)==null||qe.call(window,o(be?"subscription.copySuccess":"common.copyFailed"),be?"success":"error")}async function We(T){var be,qe;H(T.id);try{let ve=T.subscribe_url||null;if(ve||(ve=(await O1(T.id)).data,ve&&p(G=>G.map(Ne=>Ne.id===T.id?{...Ne,subscribe_url:ve}:Ne))),!ve){(be=window.showToast)==null||be.call(window,o("common.copyFailed"),"error");return}await Ge(ve)}catch(ve){(qe=window.showToast)==null||qe.call(window,ve instanceof Error?ve.message:o("common.copyFailed"),"error")}finally{H(null)}}function Ct(T){$(T),xe([]),R(0),M(1),pe(T,1)}function wt(T=te){return E?pe(E,T):Promise.resolve()}function tn(T){var be;(be=window.showConfirm)==null||be.call(window,{message:o("subscription.unbindConfirm"),onConfirm:async()=>{var qe,ve;oe(T.id);try{await wx(T.id),(qe=window.showToast)==null||qe.call(window,o("subscription.unbindSuccess"),"success"),await Promise.all([wt(),X(_,w,g)])}catch(rt){(ve=window.showToast)==null||ve.call(window,rt instanceof Error?rt.message:o("subscription.unbindFailed"),"error")}finally{oe(null)}}})}function mt(T){var be;(be=window.showConfirm)==null||be.call(window,{message:o("subscription.banConfirm"),onConfirm:async()=>{var qe,ve;oe(T.id);try{await Nx(T.id),(qe=window.showToast)==null||qe.call(window,o("subscription.banSuccess"),"success"),await Promise.all([wt(),X(_,w,g)])}catch(rt){(ve=window.showToast)==null||ve.call(window,rt instanceof Error?rt.message:o("subscription.banFailed"),"error")}finally{oe(null)}}})}function Pt(T){const be=T.device_limit&&T.device_limit>0?String(T.device_limit):o("subscription.unlimited"),qe=!!(T.device_count||T.device_limit&&T.device_limit>0);return t.jsxs("div",{className:"subscription-slot-cell",children:[t.jsxs("div",{className:"subscription-slot-count",children:[t.jsx("span",{children:T.device_count}),t.jsx("span",{children:"/"}),t.jsx("span",{children:be})]}),T.device_limit&&T.device_limit>0?t.jsx("div",{className:"subscription-slot-meter","aria-hidden":"true",children:t.jsx("span",{style:{width:`${Math.min(100,Math.round(T.device_count/T.device_limit*100))}%`}})}):t.jsx("small",{children:o("subscription.noDeviceLimit")}),qe?t.jsxs("button",{className:"mini-button subscription-slot-button",type:"button",onClick:()=>Ct(T),children:[t.jsx(Cd,{size:14}),t.jsx("span",{children:o("subscription.manageUuids")})]}):null]})}function At(T){return t.jsxs("div",{className:"subscription-traffic",children:[t.jsxs("strong",{children:[hl(T.total_used)," / ",hl(T.transfer_enable)," GB"]}),t.jsx("div",{className:"subscription-traffic-bar","aria-hidden":"true",children:t.jsx("span",{style:{width:`${Vj(T)}%`}})}),t.jsx("small",{children:o("subscription.uploadDownload",{upload:hl(T.u),download:hl(T.d)})})]})}function ye(T){return t.jsxs("div",{className:"subscription-copy-item",children:[t.jsxs("button",{className:"copy-value subscription-link",type:"button",title:T.uuid,onClick:()=>Ge(T.uuid),children:[t.jsx(jn,{size:14}),t.jsx("span",{className:"mono",children:T.uuid})]}),t.jsx("small",{children:o("subscription.primaryUuid")})]})}function Me(T){return t.jsxs("div",{className:"subscription-link-stack",children:[ye(T),T.subscribe_url?t.jsxs("div",{className:"subscription-copy-item",children:[t.jsxs("button",{className:"copy-value subscription-link",type:"button",title:T.subscribe_url,onClick:()=>void We(T),disabled:W===T.id,children:[t.jsx(jn,{size:14}),t.jsx("span",{className:"mono",children:T.subscribe_url})]}),t.jsx("small",{children:o("subscription.colSubscribeUrl")})]}):t.jsxs("div",{className:"subscription-copy-item",children:[t.jsxs("button",{className:"copy-value subscription-link",type:"button",onClick:()=>void We(T),disabled:W===T.id,children:[t.jsx(jn,{size:14}),t.jsx("span",{children:W===T.id?o("common.processing"):o("subscription.colSubscribeUrl")})]}),t.jsx("small",{children:o("subscription.colSubscribeUrl")})]})]})}function Ut(T){return t.jsxs("div",{className:"row-actions subscription-actions",children:[t.jsxs("button",{className:"mini-button",type:"button",onClick:()=>Se(T),children:[t.jsx(Bt,{size:14}),o("subscription.edit")]}),t.jsxs("button",{className:"mini-button",type:"button",disabled:ie===T.id,onClick:()=>lt(T),children:[t.jsx(Bo,{size:14}),o("subscription.resetSecret")]})]})}const Gt=Math.ceil(h/Uh),zt=Math.ceil(N/Rh),pn=Gt>1?t.jsxs("div",{className:"pagination",children:[t.jsxs("button",{className:"mini-button",type:"button",disabled:_<=1||Y,onClick:()=>void X(_-1,w,g),children:[t.jsx(ga,{size:14}),o("common.prev")]}),t.jsx("span",{className:"page-info",children:o("subscription.page",{page:_,total:Gt})}),t.jsxs("button",{className:"mini-button",type:"button",disabled:_>=Gt||Y,onClick:()=>void X(_+1,w,g),children:[o("common.next"),t.jsx(ba,{size:14})]})]}):null;return t.jsxs(Qt,{title:o("subscription.title"),subtitle:o("subscription.subtitle"),children:[t.jsx("style",{dangerouslySetInnerHTML:{__html:`
        .subscription-table {
          min-width: 1160px;
          table-layout: fixed;
        }
