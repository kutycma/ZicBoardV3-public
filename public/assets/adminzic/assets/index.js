...
`)}function vn(b){s.push(`/device?user_id=${encodeURIComponent(String(b.id))}`)}function L(b,ue="left"){const me=`${en("user.deviceOnlineShort","Online")}: ${Number(b.device_online_count??0)} | ${en("user.deviceIpShort","IP")}: ${Number(b.alive_ip??0)}`;return t.jsxs("button",{className:`device-cell-button ${ue==="right"?"align-right":""}`,type:"button",title:aa(b),onClick:()=>vn(b),children:[t.jsx("span",{className:"device-cell-primary",children:Mn(b)}),t.jsx("span",{className:"device-cell-secondary",children:me})]})}async function re(b){var ke,Ie;const ue=b.subscribe_url;if(!ue){(ke=window.showToast)==null||ke.call(window,o("user.toastNoSubscribeUrl"),"error");return}const me=await il(ue);(Ie=window.showToast)==null||Ie.call(window,o(me?"user.toastUrlCopied":"common.copyFailed"),me?"success":"error"),w(null)}function ee(b){var ue;w(null),(ue=window.showConfirm)==null||ue.call(window,{message:o("user.confirmResetSecret"),onConfirm:async()=>{var me,ke;try{await B1(b.id),(me=window.showToast)==null||me.call(window,o("user.toastSecretResetSuccess"),"success"),await Ue(j,Y,Z)}catch(Ie){(ke=window.showToast)==null||ke.call(window,Ie instanceof Error?Ie.message:o("user.toastSecretResetFailed"),"error")}}})}function Ce(b){var ue;w(null),(ue=window.showConfirm)==null||ue.call(window,{message:o("user.confirmDelete"),onConfirm:async()=>{var me,ke;try{await L1(b.id),(me=window.showToast)==null||me.call(window,o("user.toastDeletedSuccess"),"success"),await Ue(j,Y,Z)}catch(Ie){(ke=window.showToast)==null||ke.call(window,Ie instanceof Error?Ie.message:o("user.toastDeletedFailed"),"error")}}})}function Ye(b){var me;w(null);const ue=b.subscribe_url;if(!ue){(me=window.showToast)==null||me.call(window,o("user.toastNoSubscribeUrl"),"error");return}rn({url:ue,userId:b.id})}function nt(b){w(null),s.push(`/order?user_id=${b.id}`)}function ft(b){w(null),s.push(`/subscription?user_id=${b.id}`)}function ht(b){w(null),M("invite_user_id"),P(String(b.id)),Ue(1,String(b.id),"invite_user_id")}async function We(b,ue){ye(!0),Le("");try{const me=await Z1(b,ue,Me);It(me.data||[]),Qt(me.total||0),_t(ue)}catch(me){Le(me instanceof Error?me.message:o("user.historyLoading"))}finally{ye(!1)}}function pn(b){w(null),$t(b),We(b.id,1)}function fi(b){w(null),Ae(b.email),Re({plan_id:"",period:"month_price",total_amount:""})}async function hi(b){var ue,me;if(b.preventDefault(),!!ze){Et(!0);try{await jx({email:ze,plan_id:Number(Je.plan_id),period:Je.period,total_amount:(Number(Je.total_amount)||0)*100}),(ue=window.showToast)==null||ue.call(window,o("user.toastAssignSuccess"),"success"),Ae(null)}catch(ke){(me=window.showToast)==null||me.call(window,ke instanceof Error?ke.message:o("user.toastAssignFailed"),"error")}finally{Et(!1)}}}function gs(b){w(null),oe(b),V({id:b.id,email:b.email,invite_user_email:"",password:"",balance:b.balance,commission_balance:b.commission_balance,u:gd(b.u),d:gd(b.d),transfer_enable:gd(b.transfer_enable),device_limit:b.device_limit,network_settings:b.network_settings??"",expired_at:Vj(b.expired_at),plan_id:b.plan_id,banned:b.banned,commission_type:b.commission_type??0,commission_rate:b.commission_rate??"",discount:b.discount??"",speed_limit:b.speed_limit,is_admin:b.is_admin,is_staff:b.is_staff,remarks:b.remarks??""})}function Nt(b,ue){V(me=>({...me,[b]:ue}))}async function Kn(b){var ue,me;if(b.preventDefault(),!!G){de(!0);try{const ke={id:G.id,email:k.email,plan_id:k.plan_id||null,expired_at:Rh(String(k.expired_at??"")),transfer_enable:bd(Number(k.transfer_enable??0)),speed_limit:k.speed_limit||null,device_limit:k.device_limit||null,u:bd(Number(k.u??0)),d:bd(Number(k.d??0)),balance:Number(k.balance??0),commission_balance:Number(k.commission_balance??0),commission_rate:k.commission_rate!==""&&k.commission_rate!==null?Number(k.commission_rate):null,commission_type:Number(k.commission_type??0),discount:k.discount!==""&&k.discount!==null?Number(k.discount):null,network_settings:k.network_settings||null,remarks:k.remarks||null,is_admin:Number(k.is_admin??0),is_staff:Number(k.is_staff??0),banned:Number(k.banned??0)};k.invite_user_email&&(ke.invite_user_email=k.invite_user_email),k.password&&(ke.password=k.password),await H1(ke),(ue=window.showToast)==null||ue.call(window,o("user.toastSaveSuccess"),"success"),oe(null),await Ue(j,Y,Z)}catch(ke){(me=window.showToast)==null||me.call(window,ke instanceof Error?ke.message:o("user.toastSaveFailed"),"error")}finally{de(!1)}}}async function Zt(b){var ue,me;b.preventDefault(),Ne(!0);try{await q1({email_prefix:T.email_prefix,email_suffix:T.email_suffix,password:T.password||void 0,plan_id:T.plan_id?Number(T.plan_id):void 0,expired_at:Rh(T.expired_at)}),(ue=window.showToast)==null||ue.call(window,o("user.toastCreateSuccess"),"success"),_(!1),ie({email_prefix:"",email_suffix:"gmail.com",password:"",plan_id:"",expired_at:""}),await Ue(j,Y,Z)}catch(ke){(me=window.showToast)==null||me.call(window,ke instanceof Error?ke.message:o("user.toastCreateFailed"),"error")}finally{Ne(!1)}}const St=Math.ceil(x/15),Ca=yd(Z);return t.jsxs(Jt,{title:o("user.title"),subtitle:o("user.subtitle"),children:[t.jsx("style",{children:`
      ...
      `}})]})}function kw({children:s}){return t.jsx(N0,{children:t.jsx(Sw,{children:s})})}function Cw(){return t.jsx(kw,{children:t.jsxs(Py,{children:[t.jsx(kt,{path:"/login",element:t.jsx(S0,{})}),t.jsx(kt,{path:"/dashboard",element:t.jsx(U0,{})}),t.jsx(kt,{path:"/config/system",element:t.jsx(Q0,{})}),t.jsx(kt,{path:"/config/payment",element:t.jsx(K0,{})}),t.jsx(kt,{path:"/config/theme",element:t.jsx(V0,{})}),t.jsx(kt,{path:"/server/manage",element:t.jsx(Uj,{})}),t.jsx(kt,{path:"/server/group",element:t.jsx(Rj,{})}),t.jsx(kt,{path:"/server/route",element:t.jsx(qj,{})}),t.jsx(kt,{path:"/plan",element:t.jsx($j,{})}),t.jsx(kt,{path:"/order",element:t.jsx(Zj,{})}),t.jsx(kt,{path:"/coupon",element:t.jsx(Kj,{})}),t.jsx(kt,{path:"/giftcard",element:t.jsx(Jj,{})}),t.jsx(kt,{path:"/user",element:t.jsx(nw,{})}),t.jsx(kt,{path:"/subscription",element:t.jsx(dw,{})}),t.jsx(kt,{path:"/device",element:t.jsx(hw,{})}),t.jsx(kt,{path:"/webcon",element:t.jsx(yw,{})}),t.jsx(kt,{path:"/notice",element:t.jsx(vw,{})}),t.jsx(kt,{path:"/ticket",element:t.jsx(jw,{})}),t.jsx(kt,{path:"/knowledge",element:t.jsx(ww,{})}),t.jsx(kt,{path:"/queue",element:t.jsx(_w,{})}),t.jsx(kt,{path:"/",element:t.jsx(nh,{to:"/dashboard",replace:!0})}),t.jsx(kt,{path:"*",element:t.jsx(nh,{to:"/dashboard",replace:!0})})]})})}ly.createRoot(document.getElementById("root")).render(t.jsx(h.StrictMode,{children:t.jsx(lv,{children:t.jsx(Cw,{})})}));
