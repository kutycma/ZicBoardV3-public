 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Da=ee("Zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),Ia=o.createContext(null);function Fa({children:n}){const[t,s]=o.useState([]),[l,a]=o.useState(null),d=o.useCallback((S,h="success")=>{const j=Math.random().toString(36).substring(2,9);s(u=>[...u,{id:j,message:S,type:h}]),setTimeout(()=>{s(u=>u.filter(E=>E.id!==j))},5e3)},[]),c=o.useCallback(S=>{a(S)},[]);o.useEffect(()=>{typeof window<"u"&&(window.showToast=d,window.showConfirm=c)},[d,c]);const f=async()=>{if(l){try{await l.onConfirm()}catch(S){console.error("Error in onConfirm:",S)}a(null)}},b=()=>{l&&(l.onCancel&&l.onCancel(),a(null))};return e.jsxs(Ia.Provider,{value:{showToast:d,showConfirm:c},children:[n,e.jsx("div",{className:"toast-container",children:t.map(S=>{let h=ma;return S.type==="success"&&(h=mi),S.type==="error"&&(h=ta),S.type==="warning"&&(h=Zn),e.jsxs("div",{className:`toast-card toast-${S.type}`,children:[e.jsx("div",{className:"toast-icon",children:e.jsx(h,{size:18})}),e.jsx("div",{className:"toast-message",children:S.message}),e.jsx("button",{className:"toast-close",onClick:()=>s(j=>j.filter(u=>u.id!==S.id)),children:e.jsx(ke,{size:14})})]},S.id)})}),l&&e.jsx("div",{className:"confirm-backdrop",onClick:b,children:e.jsxs("div",{className:"confirm-card",onClick:S=>S.stopPropagation(),children:[e.jsxs("div",{className:"confirm-header",children:[e.jsx("div",{className:"confirm-icon",children:e.jsx(Zn,{size:22})}),e.jsx("h3",{className:"confirm-title",children:l.title||"Confirmation"})]}),e.jsx("p",{className:"confirm-message",children:l.message}),e.jsxs("div",{className:"confirm-actions",children:[e.jsx("button",{className:"confirm-btn-cancel",onClick:b,children:l.cancelText||"Cancel"}),e.jsx("button",{className:"confirm-btn-ok",onClick:f,children:l.confirmText||"Confirm"})]})]})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        .toast-container {
          position: fixed;
          top: 24px;
          right: 24px;
...
MosVPN iOS`,visible:a=>Ye(a.subscribe_url_ua_enable),fromInput:Lr}]},{key:"deposit",label:s("config.tabs.deposit"),hint:s("config.tabs.depositHint"),fields:[{key:"deposit_bounus",label:s("config.deposit.bonus"),description:s("config.deposit.bonusHelp"),type:"textarea",placeholder:"10000:500, 20000:1200",fromInput:Mn}]},{key:"ticket",label:s("config.tabs.ticket"),hint:s("config.tabs.ticketHint"),fields:[{key:"ticket_status",label:s("config.ticket.status"),description:s("config.ticket.statusHelp"),type:"select",options:Er(s)}]},{key:"invite",label:s("config.tabs.invite"),hint:s("config.tabs.inviteHint"),fields:[{key:"invite_force",label:s("config.invite.force"),description:s("config.invite.forceHelp"),type:"switch"},{key:"invite_commission",label:s("config.invite.commission"),description:s("config.invite.commissionHelp"),type:"number"},{key:"invite_gen_limit",label:s("config.invite.genLimit"),type:"number"},{key:"invite_never_expire",label:s("config.invite.neverExpire"),description:s("config.invite.neverExpireHelp"),type:"switch"},{key:"commission_first_time_enable",label:s("config.invite.firstTime"),description:s("config.invite.firstTimeHelp"),type:"switch"},{key:"commission_auto_check_enable",label:s("config.invite.autoCheck"),description:s("config.invite.autoCheckHelp"),type:"switch"},{key:"commission_withdraw_limit",label:s("config.invite.withdrawLimit"),description:s("config.invite.withdrawLimitHelp"),type:"number"},{key:"commission_withdraw_method",label:s("config.invite.withdrawMethods"),description:s("config.invite.withdrawMethodsHelp"),type:"textarea",fromInput:Mn},{key:"withdraw_close_enable",label:s("config.invite.withdrawClose"),description:s("config.invite.withdrawCloseHelp"),type:"switch"},{key:"commission_distribution_enable",label:s("config.invite.distribution"),description:s("config.invite.distributionHelp"),type:"switch"},{key:"commission_distribution_l1",label:s("config.invite.level1"),type:"number",visible:a=>Ye(a.commission_distribution_enable)},{key:"commission_distribution_l2",label:s("config.invite.level2"),type:"number",visible:a=>Ye(a.commission_distribution_enable)},{key:"commission_distribution_l3",label:s("config.invite.level3"),type:"number",visible:a=>Ye(a.commission_distribution_enable)}]},{key:"server",label:s("config.tabs.server"),hint:s("config.tabs.serverHint"),fields:[{key:"server_api_url",label:s("config.server.apiUrl"),description:s("config.server.apiUrlHelp"),type:"text"},{key:"server_token",label:s("config.server.token"),description:s("config.server.tokenHelp"),type:"text"},{key:"server_pull_interval",label:s("config.server.pullInterval"),description:s("config.server.pullIntervalHelp"),type:"number"},{key:"server_push_interval",label:s("config.server.pushInterval"),description:s("config.server.pushIntervalHelp"),type:"number"},{key:"server_node_report_min_traffic",label:s("config.server.nodeTrafficThreshold"),description:s("config.server.thresholdHelp"),type:"number"},{key:"server_device_online_min_traffic",label:s("config.server.deviceTrafficThreshold"),description:s("config.server.thresholdHelp"),type:"number"},{key:"device_limit_mode",label:s("config.server.deviceLimitMode"),description:s("config.server.deviceLimitModeHelp"),type:"switch"},{key:"zicnode_auto_tls_enable",label:s("config.server.zicnodeAutoTls"),description:s("config.server.zicnodeAutoTlsHelp"),type:"switch"},{key:"zicnode_auto_tls_dns_provider",label:s("config.server.zicnodeAutoTlsProvider"),description:s("config.server.zicnodeAutoTlsProviderHelp"),type:"text",placeholder:"cloudflare",visible:a=>Ye(a.zicnode_auto_tls_enable)},{key:"zicnode_auto_tls_dns_env",label:s("config.server.zicnodeAutoTlsDnsEnv"),description:s("config.server.zicnodeAutoTlsDnsEnvHelp"),type:"textarea",placeholder:"CF_DNS_API_TOKEN=...",visible:a=>Ye(a.zicnode_auto_tls_enable)},{key:"zicnode_auto_tls_self_fallback",label:s("config.server.zicnodeAutoTlsSelfFallback"),description:s("config.server.zicnodeAutoTlsSelfFallbackHelp"),type:"switch",visible:a=>Ye(a.zicnode_auto_tls_enable)}]},{key:"email",label:s("config.tabs.email"),hint:s("config.tabs.emailHint"),warning:s("config.email.warning"),fields:[{key:"email_host",label:s("config.email.host"),type:"text"},{key:"email_port",label:s("config.email.port"),type:"text"},{key:"email_encryption",label:s("config.email.encryption"),type:"text",placeholder:"tls"},{key:"email_username",label:s("config.email.username"),type:"text"},{key:"email_password",label:s("config.email.password"),type:"text"},{key:"email_from_address",label:s("config.email.fromAddress"),type:"text"},{key:"email_template",label:s("config.email.template"),type:"select",options:t.map(a=>({label:a,value:a}))}]},{key:"telegram",label:s("config.tabs.telegram"),hint:s("config.tabs.telegramHint"),fields:[{key:"telegram_bot_token",label:s("config.telegram.token"),description:s("config.telegram.tokenHelp"),type:"text",placeholder:"0000000000:xxxxxxxx"},{key:"telegram_bot_enable",label:s("config.telegram.enable"),description:s("config.telegram.enableHelp"),type:"switch"},{key:"telegram_discuss_link",label:s("config.telegram.group"),description:s("config.telegram.groupHelp"),type:"text",placeholder:"https://t.me/example"},{key:"apple_share_api",label:s("config.telegram.appleShareApi"),description:s("config.telegram.appleShareApiHelp"),type:"text"}]},{key:"app",label:s("config.tabs.app"),hint:s("config.tabs.appHint"),warning:s("config.app.warning"),fields:[{key:"windows_version",label:s("config.app.windowsVersion"),type:"text",placeholder:"1.0.0"},{key:"windows_download_url",label:s("config.app.windowsUrl"),type:"text",placeholder:"https://example.com/app.exe"},{key:"macos_version",label:s("config.app.macosVersion"),type:"text",placeholder:"1.0.0"},{key:"macos_download_url",label:s("config.app.macosUrl"),type:"text",placeholder:"https://example.com/app.dmg"},{key:"android_version",label:s("config.app.androidVersion"),type:"text",placeholder:"1.0.0"},{key:"android_download_url",label:s("config.app.androidUrl"),type:"text",placeholder:"https://example.com/app.apk"}]}]}function Fr(){const n=He(),{t}=me(),[s,l]=o.useState("site"),[a,d]=o.useState(null),[c,f]=o.useState([]),[b,S]=o.useState([]),[h,j]=o.useState(!0),[u,E]=o.useState(null),[B,L]=o.useState(""),C=o.useCallback(async()=>{j(!0),L("");try{const[$,I,Z]=await Promise.all([yi(),Xa(),Qa()]);d($),f(I),S(Z)}catch($){L($ instanceof Error?$.message:t("config.loadFailed"))}finally{j(!1)}},[t]);o.useEffect(()=>{if(!Re()){n.replace("/login");return}C()},[C,n]),o.useEffect(()=>{const $=document.querySelector(".config-tabs button.active");$&&$.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})},[s]);const D=o.useMemo(()=>Ir({plans:c,emailTemplates:b,t}),[c,b,t]),P=D.find($=>$.key===s)??D[0],_=(a==null?void 0:a[P.key])??{};function A($,I,Z){d(r=>r&&{...r,[$]:{...r[$],[I]:Z}})}async function O(){var Z,r,k;if(!a)return;const $=P.key==="safe"?String(((Z=window.settings)==null?void 0:Z.secure_path)??"").trim():"",I=P.key==="safe"?String(((r=a.safe)==null?void 0:r.secure_path)??"").trim():"";E(P.key),L("");try{await vi(a[P.key]),(k=window.showToast)==null||k.call(window,t("config.saveSuccess"),"success"),P.key==="safe"&&I&&I!==$&&(window.settings={...window.settings??{},secure_path:I},window.location.replace(`${window.location.origin}/${I}`))}catch(H){L(H instanceof Error?H.message:t("config.saveFailed"))}finally{E(null)}}async function R(){var $;E("mail"),L("");try{await Va(),($=window.showToast)==null||$.call(window,t("config.email.testSuccess"),"success")}catch(I){L(I instanceof Error?I.message:t("config.email.testFailed"))}finally{E(null)}}async function v(){var I;const $=String((a==null?void 0:a.telegram.telegram_bot_token)??"");E("webhook"),L("");try{await eo($),(I=window.showToast)==null||I.call(window,t("config.telegram.webhookSuccess"),"success")}catch(Z){L(Z instanceof Error?Z.message:t("config.telegram.webhookFailed"))}finally{E(null)}}return e.jsxs(Ge,{title:t("config.title"),subtitle:t("config.subtitle"),children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}}),e.jsxs("div",{className:"toolbar-row",children:[e.jsxs("div",{children:[e.jsx("h2",{children:t("config.systemConfig")}),e.jsx("p",{children:t("config.systemConfigHelp")})]}),e.jsxs("button",{className:"ghost-button",type:"button",onClick:C,disabled:h,children:[e.jsx(Oe,{size:16}),t(h?"common.refreshing":"common.refresh")]})]}),B?e.jsx("div",{className:"form-error",children:B}):null,h&&!a?e.jsx(Pe,{label:t("config.loading")}):null,a?e.jsxs("section",{className:"config-layout",children:[e.jsx("aside",{className:"config-tabs","aria-label":t("config.tabsLabel"),children:zr.map($=>{const I=D.find(Z=>Z.key===$);return I?e.jsxs("button",{className:s===$?"active":"",type:"button",onClick:()=>l($),children:[e.jsx("span",{children:I.label}),e.jsx("small",{children:I.hint})]},$):null})}),e.jsxs("div",{className:"config-panel panel",children:[e.jsxs("div",{className:"config-panel-heading",children:[e.jsxs("div",{children:[e.jsx("h2",{children:P.label}),e.jsx("p",{children:P.hint})]}),e.jsxs("button",{className:"primary-button save-button",disabled:u===P.key,type:"button",onClick:O,children:[e.jsx(rt,{size:16}),u===P.key?t("config.saving"):t("config.saveTab")]})]}),P.warning?e.jsx("div",{className:"config-warning",children:P.warning}):null,e.jsx("div",{className:"config-fields",children:P.fields.map($=>$.visible&&!$.visible(_)?null:e.jsx(Dr,{field:$,value:_[$.key],onChange:I=>A(P.key,$.key,I)},$.key))}),P.key==="email"?e.jsx("div",{className:"config-actions",children:e.jsxs("button",{className:"ghost-button",type:"button",disabled:u==="mail",onClick:R,children:[e.jsx(hi,{size:16}),t(u==="mail"?"config.email.testing":"config.email.test")]})}):null,P.key==="telegram"?e.jsxs("div",{className:"config-actions",children:[e.jsxs("button",{className:"ghost-button",type:"button",disabled:u==="webhook",onClick:v,children:[e.jsx(Ma,{size:16}),t(u==="webhook"?"config.telegram.settingWebhook":"config.telegram.setWebhook")]}),e.jsxs("span",{children:[e.jsx(xi,{size:14}),t("config.telegram.webhookHelp")]})]}):null]})]}):null]})}async function Pt(n){var s;if(typeof window>"u"||typeof document>"u")return!1;if((s=navigator.clipboard)!=null&&s.writeText&&window.isSecureContext)try{return await navigator.clipboard.writeText(n),!0}catch{}const t=document.createElement("textarea");t.value=n,t.setAttribute("readonly",""),t.style.position="fixed",t.style.left="-9999px",t.style.top="0",document.body.appendChild(t),t.select(),t.setSelectionRange(0,t.value.length);try{return document.execCommand("copy")}catch{return!1}finally{document.body.removeChild(t)}}function Ln(n){return n===!0||n===1||n==="1"}function Ar(n,t=""){return{id:n==null?void 0:n.id,name:(n==null?void 0:n.name)??"",icon:(n==null?void 0:n.icon)??"",notify_domain:(n==null?void 0:n.notify_domain)??"",handling_fee_fixed:(n==null?void 0:n.handling_fee_fixed)===null||(n==null?void 0:n.handling_fee_fixed)===void 0?"":String(Number(n.handling_fee_fixed)/100),handling_fee_percent:(n==null?void 0:n.handling_fee_percent)===null||(n==null?void 0:n.handling_fee_percent)===void 0?"":String(n.handling_fee_percent),payment:(n==null?void 0:n.payment)??t,config:{...(n==null?void 0:n.config)??{}}}}function Or(n){return{id:n.id,name:n.name,icon:n.icon||null,notify_domain:n.notify_domain||null,handling_fee_fixed:n.handling_fee_fixed===""?null:Math.round(Number(n.handling_fee_fixed)*100),handling_fee_percent:n.handling_fee_percent===""?null:n.handling_fee_percent,payment:n.payment,config:n.config}}function Rr(){const n=He(),{t}=me(),[s,l]=o.useState([]),[a,d]=o.useState([]),[c,f]=o.useState(null),[b,S]=o.useState({}),[h,j]=o.useState(!0),[u,E]=o.useState(!1),[B,L]=o.useState(!1),[C,D]=o.useState(""),[P,_]=o.useState(""),[A,O]=o.useState({}),R=o.useCallback(async()=>{j(!0),D("");try{const[z,G]=await Promise.all([to(),no()]);l(z),d(G),O({})}catch(z){D(z instanceof Error?z.message:t("payment.loadFailed"))}finally{j(!1)}},[t]);o.useEffect(()=>{if(!Re()){n.replace("/login");return}R()},[R,n]);async function v(z){const G=(z==null?void 0:z.payment)??a[0]??"",w=Ar(z,G);if(f(w),S({}),D(""),_(""),!!G){E(!0);try{S(await ws(G,z==null?void 0:z.id))}catch(F){D(F instanceof Error?F.message:t("payment.formLoadFailed"))}finally{E(!1)}}}async function $(z){if(c){f({...c,payment:z,config:{}}),E(!0),D("");try{S(await ws(z,c.id))}catch(G){D(G instanceof Error?G.message:t("payment.formLoadFailed"))}finally{E(!1)}}}async function I(z){var G,w;if(z.preventDefault(),!!c){L(!0),D(""),_("");try{await so(Or(c)),f(null),(G=window.showToast)==null||G.call(window,t("payment.saveSuccess"),"success"),await R()}catch(F){(w=window.showToast)==null||w.call(window,F instanceof Error?F.message:t("payment.saveFailed"),"error")}finally{L(!1)}}}async function Z(z){var G;D(""),_("");try{await io(z),await R()}catch(w){(G=window.showToast)==null||G.call(window,w instanceof Error?w.message:t("payment.toggleFailed"),"error")}}async function r(z){var G;(G=window.showConfirm)==null||G.call(window,{message:t("payment.deleteConfirm"),onConfirm:async()=>{var w,F;D(""),_("");try{await ao(z),(w=window.showToast)==null||w.call(window,t("payment.deleteSuccess"),"success"),await R()}catch(M){(F=window.showToast)==null||F.call(window,M instanceof Error?M.message:t("payment.deleteFailed"),"error")}}})}async function k(z,G){var se;const w=z+G;if(w<0||w>=s.length)return;const F=[...s],M=F[z];F.splice(z,1),F.splice(w,0,M),l(F);try{await oo(F.map(g=>g.id)),await R()}catch(g){(se=window.showToast)==null||se.call(window,g instanceof Error?g.message:t("payment.sortFailed"),"error"),await R()}}async function H(z){var w;const G=await Pt(z);(w=window.showToast)==null||w.call(window,t(G?"payment.copied":"common.copyFailed"),G?"success":"error")}return e.jsxs(Ge,{title:t("payment.title"),subtitle:t("payment.subtitle"),children:[e.jsxs("div",{className:"toolbar-row",children:[e.jsxs("div",{children:[e.jsx("h2",{children:t("payment.methods")}),e.jsx("p",{children:t("payment.methodsHelp")})]}),e.jsxs("div",{className:"button-row",children:[e.jsxs("button",{className:"ghost-button",type:"button",onClick:R,disabled:h,children:[e.jsx(Oe,{size:16}),e.jsx("span",{children:t(h?"common.refreshing":"common.refresh")})]}),e.jsxs("button",{className:"primary-button",type:"button",onClick:()=>void v(),children:[e.jsx(ot,{size:16}),e.jsx("span",{children:t("payment.add")})]})]})]}),C?e.jsx("div",{className:"form-error",children:C}):null,P?e.jsx("div",{className:"form-success",children:P}):null,h&&s.length===0?e.jsx(Pe,{label:t("payment.loading")}):null,e.jsx("style",{dangerouslySetInnerHTML:{__html:`
...
`)}function At(i){n.push(`/device?user_id=${encodeURIComponent(String(i.id))}`)}function Lt(i,m="left"){const N=`${et("user.deviceOnlineShort","Online")}: ${Number(i.device_online_count??0)} | ${et("user.deviceIpShort","IP")}: ${Number(i.alive_ip??0)}`;return e.jsxs("button",{className:`device-cell-button ${m==="right"?"align-right":""}`,type:"button",title:Gt(i),onClick:()=>At(i),children:[e.jsx("span",{className:"device-cell-primary",children:pt(i)}),e.jsx("span",{className:"device-cell-secondary",children:N})]})}async function Dt(i){var U,X;const m=i.subscribe_url;if(!m){(U=window.showToast)==null||U.call(window,s("user.toastNoSubscribeUrl"),"error");return}const N=await Pt(m);(X=window.showToast)==null||X.call(window,s(N?"user.toastUrlCopied":"common.copyFailed"),N?"success":"error"),r(null)}function Ot(i){var m;r(null),(m=window.showConfirm)==null||m.call(window,{message:s("user.confirmResetSecret"),onConfirm:async()=>{var N,U;try{await $o(i.id),(N=window.showToast)==null||N.call(window,s("user.toastSecretResetSuccess"),"success"),await ue(j,E,L)}catch(X){(U=window.showToast)==null||U.call(window,X instanceof Error?X.message:s("user.toastSecretResetFailed"),"error")}}})}function Nt(i){var m;r(null),(m=window.showConfirm)==null||m.call(window,{message:s("user.confirmDelete"),onConfirm:async()=>{var N,U;try{await To(i.id),(N=window.showToast)==null||N.call(window,s("user.toastDeletedSuccess"),"success"),await ue(j,E,L)}catch(X){(U=window.showToast)==null||U.call(window,X instanceof Error?X.message:s("user.toastDeletedFailed"),"error")}}})}function kt(i){var N;r(null);const m=i.subscribe_url;if(!m){(N=window.showToast)==null||N.call(window,s("user.toastNoSubscribeUrl"),"error");return}We({url:m,userId:i.id})}function Rt(i){r(null),n.push(`/order?user_id=${i.id}`)}function p(i){r(null),n.push(`/subscription?user_id=${i.id}`)}function K(i){r(null),C("invite_user_id"),B(String(i.id)),ue(1,String(i.id),"invite_user_id")}async function ne(i,m){pe(!0),st("");try{const N=await Fo(i,m,ae);be(N.data||[]),he(N.total||0),Ue(m)}catch(N){st(N instanceof Error?N.message:s("user.historyLoading"))}finally{pe(!1)}}function ce(i){r(null),ie(i),ne(i.id,1)}function Le(i){r(null),Me(i.email),Ne({plan_id:"",period:"month_price",total_amount:""})}async function ut(i){var m,N;if(i.preventDefault(),!!Ee){Se(!0);try{await ls({email:Ee,plan_id:Number(_e.plan_id),period:_e.period,total_amount:(Number(_e.total_amount)||0)*100}),(m=window.showToast)==null||m.call(window,s("user.toastAssignSuccess"),"success"),Me(null)}catch(U){(N=window.showToast)==null||N.call(window,U instanceof Error?U.message:s("user.toastAssignFailed"),"error")}finally{Se(!1)}}}function ft(i){r(null),G(i),F({id:i.id,email:i.email,invite_user_email:"",password:"",balance:i.balance,commission_balance:i.commission_balance,u:An(i.u),d:An(i.d),transfer_enable:An(i.transfer_enable),device_limit:i.device_limit,expired_at:Ul(i.expired_at),plan_id:i.plan_id,banned:i.banned,commission_type:i.commission_type??0,commission_rate:i.commission_rate??"",discount:i.discount??"",speed_limit:i.speed_limit,is_admin:i.is_admin,is_staff:i.is_staff,is_manager:i.is_manager,remarks:i.remarks??""})}function De(i,m){F(N=>({...N,[i]:m}))}async function _t(i){var m,N;if(i.preventDefault(),!!z){se(!0);try{const U={id:z.id,email:w.email,plan_id:w.plan_id||null,expired_at:Ws(String(w.expired_at??"")),transfer_enable:On(Number(w.transfer_enable??0)),speed_limit:w.speed_limit||null,device_limit:w.device_limit||null,u:On(Number(w.u??0)),d:On(Number(w.d??0)),balance:Number(w.balance??0),commission_balance:Number(w.commission_balance??0),commission_rate:w.commission_rate!==""&&w.commission_rate!==null?Number(w.commission_rate):null,commission_type:Number(w.commission_type??0),discount:w.discount!==""&&w.discount!==null?Number(w.discount):null,remarks:w.remarks||null,is_admin:Number(w.is_admin??0),is_staff:Number(w.is_staff??0),is_manager:Number(w.is_manager??0),banned:Number(w.banned??0)};w.invite_user_email&&(U.invite_user_email=w.invite_user_email),w.password&&(U.password=w.password),await zo(U),(m=window.showToast)==null||m.call(window,s("user.toastSaveSuccess"),"success"),G(null),await ue(j,E,L)}catch(U){(N=window.showToast)==null||N.call(window,U instanceof Error?U.message:s("user.toastSaveFailed"),"error")}finally{se(!1)}}}async function Ht(i){var m,N;i.preventDefault(),$e(!0);try{await Po({email_prefix:q.email_prefix,email_suffix:q.email_suffix,password:q.password||void 0,plan_id:q.plan_id?Number(q.plan_id):void 0,expired_at:Ws(q.expired_at)}),(m=window.showToast)==null||m.call(window,s("user.toastCreateSuccess"),"success"),V(!1),Q({email_prefix:"",email_suffix:"gmail.com",password:"",plan_id:"",expired_at:""}),await ue(j,E,L)}catch(U){(N=window.showToast)==null||N.call(window,U instanceof Error?U.message:s("user.toastCreateFailed"),"error")}finally{$e(!1)}}const lt=Math.ceil(S/15),x=Rn(L);return e.jsxs(Ge,{title:s("user.title"),subtitle:s("user.subtitle"),children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"toolbar-row",children:[e.jsxs("div",{children:[e.jsx("h2",{children:s("user.heading")}),e.jsxs("p",{children:[S," ",s("user.totalUsers")]})]}),e.jsxs("div",{className:"button-row",children:[e.jsxs("div",{className:"col-picker-wrap",ref:I,children:[e.jsxs("button",{className:"ghost-button",type:"button",onClick:()=>$(!v),children:[e.jsx(sa,{size:16}),s("user.columns")]}),v?e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"col-picker-backdrop",type:"button","aria-label":s("common.closeMenu"),onClick:()=>$(!1)}),e.jsxs("div",{className:"col-picker-dropdown",children:[e.jsx("div",{className:"col-picker-header",children:e.jsx("span",{children:s("user.visibleColumns",{count:ye})})}),e.jsx("div",{className:"col-picker-list",children:ss.map(i=>e.jsxs("label",{className:"col-picker-item",children:[e.jsx("input",{type:"checkbox",checked:O.has(i.key),onChange:()=>re(i.key)}),e.jsx("span",{children:Xe(i.key,s)})]},i.key))})]})]}):null]}),e.jsxs("button",{className:"ghost-button",type:"button",onClick:()=>void ue(j,E,L),disabled:D,children:[e.jsx(Oe,{size:16}),s("common.refresh")]}),e.jsxs("button",{className:"primary-button",type:"button",onClick:()=>V(!0),children:[e.jsx(ot,{size:16}),s("user.createUser")]})]})]}),e.jsxs("div",{className:"filter-bar",children:[e.jsx("select",{className:"config-input filter-select",value:L,onChange:i=>C(i.target.value),children:_n.map(i=>e.jsx("option",{value:i.value,children:Wl(i.value,s)},i.value))}),e.jsxs("div",{className:"search-input-wrap",children:[e.jsx(Sn,{size:16}),e.jsx("input",{className:"config-input search-input",value:E,onChange:i=>B(i.target.value),placeholder:x.placeholder,onKeyDown:i=>i.key==="Enter"&&Te()})]}),e.jsxs("button",{className:"ghost-button",type:"button",onClick:Te,children:[e.jsx(en,{size:16}),s("user.filter")]}),E?e.jsxs("button",{className:"ghost-button",type:"button",onClick:Qe,children:[e.jsx(ke,{size:16}),s("user.clearFilter")]}):null]}),_?e.jsx("div",{className:"form-error",children:_}):null,D&&l.length===0?e.jsx(Pe,{label:s("user.loading")}):null,e.jsxs("div",{className:`content-loading-container ${D?"is-loading":""}`,children:[e.jsx("div",{className:"page-loading-bar"}),e.jsxs("div",{className:"mobile-user-list",children:[l.map(i=>{const m=pn(i.u+i.d),N=pn(i.transfer_enable),U=parseFloat(m);return e.jsxs("div",{className:"mobile-user-card",children:[e.jsxs("div",{className:"mobile-user-card-header",children:[e.jsxs("div",{className:"user-id-email",children:[e.jsxs("span",{className:"user-id",children:["#",i.id]}),e.jsx("span",{className:"user-email",title:i.email,children:i.email})]}),i.banned?e.jsx("span",{className:"status-tag banned",children:s("user.cardBanned")}):e.jsx("span",{className:"status-tag normal",children:s("user.cardActive")})]}),e.jsxs("div",{className:"mobile-user-card-body",children:[e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:s("user.planGroupLabel")}),e.jsxs("span",{className:"info-val",children:[qe(i)," / ",i.is_admin?e.jsx("span",{style:{fontWeight:600},children:s("user.adminLabel")}):Mt(i)]})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:s("user.trafficUsedLimitLabel")}),e.jsxs("span",{className:"info-val",children:[e.jsxs("span",{className:`traffic-used ${U>0?U>parseFloat(N)*.9?"high":"ok":""}`,children:[m," GB"]})," / ",N," GB"]})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:Xe("devices",s)}),e.jsx("span",{className:"info-val",children:Lt(i,"right")})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:Xe("expires",s)}),e.jsx("span",{className:"info-val",children:i.expired_at?e.jsx("span",{className:`expiry-date ${i.expired_at<Date.now()/1e3?"expired":""}`,children:dn(i.expired_at)}):e.jsx("span",{className:"expiry-none",children:"—"})})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:s("user.balanceCommLabel")}),e.jsxs("span",{className:"info-val",children:[(i.balance/100).toFixed(2)," ₫ / ",(i.commission_balance/100).toFixed(2)," ₫"]})]}),e.jsxs("div",{className:"info-row",children:[e.jsx("span",{className:"info-label",children:Xe("joined",s)}),e.jsx("span",{className:"info-val",children:e.jsx("small",{children:dn(i.created_at)})})]})]}),e.jsx("div",{className:"mobile-user-card-actions",children:e.jsxs("div",{className:`action-dropdown-wrap ${Z===i.id?"active":""}`,children:[e.jsxs("button",{className:"action-dropdown-btn",type:"button",onClick:()=>r(Z===i.id?null:i.id),children:[s("user.colActions")," ",e.jsx(vt,{size:14})]}),Z===i.id?e.jsx("div",{className:"mobile-action-sheet-backdrop",onClick:()=>r(null),children:e.jsxs("div",{className:"mobile-action-sheet",onClick:X=>X.stopPropagation(),children:[e.jsxs("div",{className:"mobile-action-sheet-head",children:[e.jsxs("div",{children:[e.jsx("strong",{children:i.email}),e.jsxs("small",{children:["#",i.id]})]}),e.jsx("button",{className:"icon-button",type:"button",onClick:()=>r(null),children:e.jsx(ke,{size:16})})]}),le(i,!1,"mobile-action-menu")]})}):null]})})]},i.id)}),!D&&l.length===0?e.jsx("div",{className:"empty-state",children:s("user.noUsers")}):null]}),e.jsx("section",{className:"panel table-panel hide-on-mobile",children:e.jsx("div",{className:"admin-table-wrap",children:e.jsxs("table",{className:"admin-table user-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[te("id")&&e.jsx("th",{children:Xe("id",s)}),te("email")&&e.jsx("th",{children:Xe("email",s)}),te("status")&&e.jsx("th",{children:Xe("status",s)}),te("plan")&&e.jsx("th",{children:Xe("plan",s)}),te("group")&&e.jsx("th",{children:Xe("group",s)}),te("used")&&e.jsx("th",{children:Xe("used",s)}),te("traffic")&&e.jsx("th",{children:Xe("traffic",s)}),te("devices")&&e.jsx("th",{children:Xe("devices",s)}),te("expires")&&e.jsx("th",{children:Xe("expires",s)}),te("balance")&&e.jsx("th",{children:Xe("balance",s)}),te("commission")&&e.jsx("th",{children:Xe("commission",s)}),te("joined")&&e.jsx("th",{children:Xe("joined",s)}),te("actions")&&e.jsx("th",{className:"user-actions-col",children:Xe("actions",s)})]})}),e.jsxs("tbody",{children:[l.map(i=>{const m=pn(i.u+i.d),N=pn(i.transfer_enable),U=parseFloat(m);return e.jsxs("tr",{children:[te("id")&&e.jsx("td",{children:i.id}),te("email")&&e.jsx("td",{children:e.jsx("span",{className:"email-link",children:i.email})}),te("status")&&e.jsx("td",{children:i.banned?e.jsx("span",{className:"status-tag banned",children:s("user.cardBanned")}):e.jsx("span",{className:"status-tag normal",children:s("user.cardActive")})}),te("plan")&&e.jsx("td",{children:qe(i)}),te("group")&&e.jsx("td",{children:i.is_admin?e.jsx("span",{style:{fontWeight:600},children:s("user.adminLabel")}):Mt(i)}),te("used")&&e.jsx("td",{children:e.jsx("span",{className:`traffic-used ${U>0?U>parseFloat(N)*.9?"high":"ok":""}`,children:m})}),te("traffic")&&e.jsx("td",{children:N}),te("devices")&&e.jsx("td",{children:Lt(i)}),te("expires")&&e.jsx("td",{children:i.expired_at?e.jsx("span",{className:`expiry-date ${i.expired_at<Date.now()/1e3?"expired":""}`,children:dn(i.expired_at)}):e.jsx("span",{className:"expiry-none",children:"—"})}),te("balance")&&e.jsx("td",{children:(i.balance/100).toFixed(2)}),te("commission")&&e.jsx("td",{children:(i.commission_balance/100).toFixed(2)}),te("joined")&&e.jsx("td",{children:e.jsx("small",{children:dn(i.created_at)})}),te("actions")&&e.jsx("td",{className:"user-actions-col",children:e.jsxs("div",{className:`action-dropdown-wrap ${Z===i.id?"active":""}`,children:[e.jsxs("button",{className:"action-dropdown-btn",type:"button",onClick:X=>it(i.id,X.currentTarget),children:[s("user.colActions")," ",e.jsx(vt,{size:14})]}),Z===i.id&&k?ci.createPortal(le(i,!0),document.body):null]})})]},i.id)}),!D&&l.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:ye,children:e.jsx("div",{className:"empty-state",children:s("user.noUsers")})})}):null]})]})})}),lt>1?e.jsx("div",{className:"pagination-wrap",children:e.jsxs("div",{className:"pagination",children:[e.jsx("button",{className:"mini-button",disabled:j<=1,onClick:()=>Ve(j-1),children:e.jsx(jt,{size:16})}),Array.from({length:Math.min(5,lt)},(i,m)=>{let N;return lt<=5||j<=3?N=m+1:j>=lt-2?N=lt-4+m:N=j-2+m,e.jsx("button",{className:`mini-button ${N===j?"active-page":""}`,onClick:()=>Ve(N),children:N},N)}),lt>5?e.jsxs("span",{className:"page-info",children:["… ",lt]}):null,e.jsx("button",{className:"mini-button",disabled:j>=lt,onClick:()=>Ve(j+1),children:e.jsx(wt,{size:16})})]})}):null]}),z?e.jsx("div",{className:"modal-backdrop",onClick:()=>G(null),children:e.jsxs("section",{className:"modal-panel edit-user-modal",onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"modal-heading",children:[e.jsx("h2",{children:s("user.editUser")}),e.jsx("button",{className:"icon-button",type:"button",onClick:()=>G(null),children:e.jsx(ke,{size:18})})]}),e.jsxs("form",{className:"modal-body-scroll",onSubmit:_t,children:[e.jsxs("label",{className:"field-label",children:[s("user.email"),e.jsx("input",{className:"config-input",type:"email",required:!0,value:String(w.email??""),onChange:i=>De("email",i.target.value)})]}),e.jsxs("label",{className:"field-label",children:[s("user.inviterEmailLabel"),e.jsx("input",{className:"config-input",type:"email",value:String(w.invite_user_email??""),onChange:i=>De("invite_user_email",i.target.value),placeholder:s("user.inviterEmailLabel")})]}),e.jsxs("label",{className:"field-label",children:[s("user.password"),e.jsx("input",{className:"config-input",type:"password",value:String(w.password??""),onChange:i=>De("password",i.target.value),placeholder:s("user.passwordPlaceholder"),minLength:8})]}),e.jsxs("div",{className:"form-row-2",children:[e.jsxs("label",{className:"field-label",children:[s("user.balance"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",step:"0.01",value:String((Number(w.balance??0)/100).toFixed(2)),onChange:i=>De("balance",Math.round(Number(i.target.value)*100))}),e.jsx("span",{className:"input-suffix",children:"₫"})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.commissionBalance"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",step:"0.01",value:String((Number(w.commission_balance??0)/100).toFixed(2)),onChange:i=>De("commission_balance",Math.round(Number(i.target.value)*100))}),e.jsx("span",{className:"input-suffix",children:"₫"})]})]})]}),e.jsxs("div",{className:"form-row-2",children:[e.jsxs("label",{className:"field-label",children:[s("user.uploadLabel"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(w.u??0),onChange:i=>De("u",i.target.value)}),e.jsx("span",{className:"input-suffix",children:"GB"})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.downloadLabel"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(w.d??0),onChange:i=>De("d",i.target.value)}),e.jsx("span",{className:"input-suffix",children:"GB"})]})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.transferEnable"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",step:"0.01",min:"0",value:String(w.transfer_enable??0),onChange:i=>De("transfer_enable",i.target.value)}),e.jsx("span",{className:"input-suffix",children:"GB"})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.deviceLimit"),e.jsx("input",{className:"config-input",type:"number",min:"0",value:String(w.device_limit??""),onChange:i=>De("device_limit",i.target.value?Number(i.target.value):null),placeholder:s("user.deviceLimitPlaceholder")})]}),e.jsxs("label",{className:"field-label",children:[s("user.expiredAt"),e.jsx("input",{className:"config-input",type:"date",value:String(w.expired_at??""),onChange:i=>De("expired_at",i.target.value),onClick:i=>{var m,N;return(N=(m=i.currentTarget).showPicker)==null?void 0:N.call(m)},onFocus:i=>{var m,N;return(N=(m=i.currentTarget).showPicker)==null?void 0:N.call(m)}})]}),e.jsxs("label",{className:"field-label",children:[s("user.plan"),e.jsxs("select",{className:"config-input",value:String(w.plan_id??""),onChange:i=>De("plan_id",i.target.value?Number(i.target.value):null),children:[e.jsx("option",{value:"",children:s("user.planNone")}),d.map(i=>e.jsx("option",{value:i.id,children:i.name},i.id))]})]}),e.jsxs("label",{className:"field-label",children:[s("user.accountStatusLabel"),e.jsxs("select",{className:"config-input",value:String(w.banned??0),onChange:i=>De("banned",Number(i.target.value)),children:[e.jsx("option",{value:"0",children:s("user.cardActive")}),e.jsx("option",{value:"1",children:s("user.cardBanned")})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.commissionTypeLabel"),e.jsxs("select",{className:"config-input",value:String(w.commission_type??0),onChange:i=>De("commission_type",Number(i.target.value)),children:[e.jsx("option",{value:"0",children:s("user.commissionTypeSystem")}),e.jsx("option",{value:"1",children:s("user.commissionTypeFixed")}),e.jsx("option",{value:"2",children:s("user.commissionTypePercent")})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.commissionRate"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",min:"0",max:"100",value:String(w.commission_rate??""),onChange:i=>De("commission_rate",i.target.value),placeholder:s("user.commissionRatePlaceholder")}),e.jsx("span",{className:"input-suffix",children:"%"})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.discount"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",min:"0",max:"100",value:String(w.discount??""),onChange:i=>De("discount",i.target.value),placeholder:s("user.exclusiveDiscountPlaceholder")}),e.jsx("span",{className:"input-suffix",children:"%"})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.speedLimit"),e.jsxs("div",{className:"input-with-suffix",children:[e.jsx("input",{className:"config-input",type:"number",min:"0",value:String(w.speed_limit??""),onChange:i=>De("speed_limit",i.target.value?Number(i.target.value):null),placeholder:s("user.speedLimitPlaceholder")}),e.jsx("span",{className:"input-suffix",children:"Mbps"})]})]}),e.jsxs("div",{className:"toggle-field",children:[e.jsx("span",{className:"field-label-text",children:s("user.adminLabel")}),e.jsx("button",{type:"button",className:`admin-switch ${w.is_admin?"active":""}`,onClick:()=>De("is_admin",w.is_admin?0:1),children:e.jsx("span",{className:"admin-switch-thumb"})})]}),e.jsxs("div",{className:"toggle-field",children:[e.jsx("span",{className:"field-label-text",children:s("user.managerLabel")}),e.jsx("button",{type:"button",className:`admin-switch ${w.is_manager?"active":""}`,onClick:()=>De("is_manager",w.is_manager?0:1),children:e.jsx("span",{className:"admin-switch-thumb"})})]}),e.jsxs("div",{className:"toggle-field",children:[e.jsx("span",{className:"field-label-text",children:s("user.staffLabel")}),e.jsx("button",{type:"button",className:`admin-switch ${w.is_staff?"active":""}`,onClick:()=>De("is_staff",w.is_staff?0:1),children:e.jsx("span",{className:"admin-switch-thumb"})})]}),e.jsxs("label",{className:"field-label",children:[s("user.remarks"),e.jsx("textarea",{className:"config-input",rows:3,value:String(w.remarks??""),onChange:i=>De("remarks",i.target.value),placeholder:s("user.remarksPlaceholder")})]}),e.jsxs("div",{className:"modal-footer",children:[e.jsx("button",{className:"ghost-button",type:"button",onClick:()=>G(null),children:s("common.cancel")}),e.jsx("button",{className:"primary-button",type:"submit",disabled:M,children:s(M?"common.processing":"common.save")})]})]})]})}):null,g?e.jsx("div",{className:"modal-backdrop",onClick:()=>V(!1),children:e.jsxs("section",{className:"modal-panel compact-modal",onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"modal-heading",children:[e.jsx("h2",{children:s("user.createUser")}),e.jsx("button",{className:"icon-button",type:"button",onClick:()=>V(!1),children:e.jsx(ke,{size:18})})]}),e.jsxs("form",{className:"modal-form",onSubmit:Ht,children:[e.jsxs("label",{className:"field-label",children:[s("user.email"),e.jsxs("div",{className:"email-compose",children:[e.jsx("input",{className:"config-input",required:!0,value:q.email_prefix,onChange:i=>Q({...q,email_prefix:i.target.value}),placeholder:s("user.emailPrefix")}),e.jsx("span",{className:"email-at",children:"@"}),e.jsx("input",{className:"config-input",required:!0,value:q.email_suffix,onChange:i=>Q({...q,email_suffix:i.target.value}),placeholder:s("user.emailSuffix")})]})]}),e.jsxs("label",{className:"field-label",children:[s("user.password"),e.jsx("input",{className:"config-input",type:"password",value:q.password,onChange:i=>Q({...q,password:i.target.value}),placeholder:s("user.createPasswordPlaceholder"),minLength:8})]}),e.jsxs("label",{className:"field-label",children:[s("user.plan"),e.jsxs("select",{className:"config-input",value:q.plan_id,onChange:i=>Q({...q,plan_id:i.target.value}),children:[e.jsx("option",{value:"",children:s("user.planNone")}),d.map(i=>e.jsx("option",{value:i.id,children:i.name},i.id))]})]}),e.jsxs("label",{className:"field-label",children:[s("user.expiredAt"),e.jsx("input",{className:"config-input",type:"date",value:q.expired_at,onChange:i=>Q({...q,expired_at:i.target.value}),onClick:i=>{var m,N;return(N=(m=i.currentTarget).showPicker)==null?void 0:N.call(m)},onFocus:i=>{var m,N;return(N=(m=i.currentTarget).showPicker)==null?void 0:N.call(m)}})]}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"ghost-button",type:"button",onClick:()=>V(!1),children:s("common.cancel")}),e.jsx("button",{className:"primary-button",type:"submit",disabled:de,children:s(de?"user.creating":"user.createUser")})]})]})]})}):null,Ee?e.jsx("div",{className:"modal-backdrop",onClick:()=>Me(null),children:e.jsxs("section",{className:"modal-panel compact-modal",onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"modal-heading",children:[e.jsx("h2",{children:s("user.assignOrderTitle")}),e.jsx("button",{className:"icon-button",type:"button",onClick:()=>Me(null),children:e.jsx(ke,{size:18})})]}),e.jsxs("form",{className:"modal-form",onSubmit:ut,children:[e.jsxs("label",{className:"field-label",children:[s("user.email"),e.jsx("input",{className:"config-input",type:"email",readOnly:!0,value:Ee})]}),e.jsxs("label",{className:"field-label",children:[s("user.plan"),e.jsxs("select",{className:"config-input",required:!0,value:_e.plan_id,onChange:i=>Ne({..._e,plan_id:i.target.value}),children:[e.jsx("option",{value:"",children:s("user.assignPlanSelect")}),d.map(i=>e.jsx("option",{value:i.id,children:i.name},i.id))]})]}),e.jsxs("label",{className:"field-label",children:[s("user.assignPeriodLabel"),e.jsx("select",{className:"config-input",value:_e.period,onChange:i=>Ne({..._e,period:i.target.value}),children:Gl.map(i=>e.jsx("option",{value:i.value,children:Kl(i.value,s)},i.value))})]}),e.jsxs("label",{className:"field-label",children:[s("user.assignTotalAmountLabel"),e.jsx("input",{className:"config-input",type:"number",min:"0",step:"0.01",value:_e.total_amount,onChange:i=>Ne({..._e,total_amount:i.target.value}),placeholder:"0"})]}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"ghost-button",type:"button",onClick:()=>Me(null),children:s("common.cancel")}),e.jsx("button",{className:"primary-button",type:"submit",disabled:fe,children:s(fe?"common.processing":"common.save")})]})]})]})}):null,e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        /* ── column picker ─────────────────────── */
        .col-picker-wrap {
          position: relative;
          display: inline-block;
      ...
      `}}),e.jsxs("div",{className:"toolbar-row webcon-toolbar",children:[e.jsxs("div",{children:[e.jsx("h2",{children:t("webcon.heading")}),e.jsx("p",{children:t("webcon.sitesCount",{count:s.length})})]}),e.jsxs("div",{className:"button-row",children:[e.jsxs("button",{className:"ghost-button",type:"button",disabled:b,onClick:()=>void C(),children:[e.jsx(Oe,{size:16}),t(b?"common.refreshing":"common.refresh")]}),e.jsxs("button",{className:"primary-button",type:"button",onClick:()=>f(ti()),children:[e.jsx(ot,{size:16}),t("webcon.add")]})]})]}),B?e.jsx("div",{className:"form-error",children:B}):null,b&&s.length===0?e.jsx(Pe,{label:t("common.loading")}):null,e.jsx("section",{className:"panel table-panel",children:e.jsx("div",{className:"admin-table-wrap",children:e.jsxs("table",{className:"admin-table webcon-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:t("webcon.colId")}),e.jsx("th",{children:t("webcon.colStatus")}),e.jsx("th",{children:t("webcon.colStaffOwner")}),e.jsx("th",{children:t("webcon.colDomain")}),e.jsx("th",{children:t("webcon.colLanding")}),e.jsx("th",{children:t("webcon.colPlans")}),e.jsx("th",{children:t("webcon.colCreated")}),e.jsx("th",{children:t("webcon.colActions")})]})}),e.jsxs("tbody",{children:[s.map(v=>{var I;const $=us(v.plan_id);return e.jsxs("tr",{children:[e.jsxs("td",{children:["#",v.id]}),e.jsx("td",{children:e.jsx("button",{className:`admin-switch ${mc(v.status)?"active":""}`,type:"button",disabled:u===v.id,onClick:()=>void O(v),"aria-label":t("webcon.toggleStatusLabel"),children:e.jsx("span",{className:"admin-switch-thumb"})})}),e.jsx("td",{children:e.jsxs("div",{className:"webcon-owner",children:[e.jsx("strong",{children:v.email??"-"}),e.jsx("small",{children:Number(v.staff)===1?t("webcon.staffEnabled"):t("webcon.staffDisabled")})]})}),e.jsx("td",{children:e.jsxs("div",{className:"webcon-domain",children:[e.jsx("strong",{className:"mono",children:v.domain}),e.jsx("small",{children:t("webcon.adminPath",{path:`/${String(((I=window.settings)==null?void 0:I.secure_path)??"admin")}/webcon`})})]})}),e.jsx("td",{children:e.jsxs("div",{className:"webcon-title",children:[e.jsx("strong",{children:v.title||"-"}),e.jsx("small",{children:v.description||t("webcon.noDescription")}),e.jsxs("span",{className:"webcon-branding",children:[e.jsxs("span",{children:[e.jsx(ua,{size:13}),v.logo?t("webcon.logo"):t("webcon.noLogo")]}),e.jsxs("span",{children:[e.jsx(nn,{size:13}),v.background_url?t("webcon.background"):t("webcon.noBackground")]})]})]})}),e.jsx("td",{children:e.jsxs("div",{className:"webcon-plan-list",children:[e.jsx("strong",{children:ni($,D,t)}),e.jsx("small",{children:$.length?t("webcon.selectedCount",{count:$.length}):t("webcon.unrestricted")})]})}),e.jsx("td",{children:uc(v.created_at)}),e.jsx("td",{children:e.jsxs("div",{className:"row-actions webcon-actions",children:[e.jsxs("button",{className:"mini-button",type:"button",onClick:()=>f(ti(v)),children:[e.jsx(Be,{size:14}),t("common.edit")]}),e.jsxs("button",{className:"mini-button danger",type:"button",disabled:u===v.id,onClick:()=>R(v),children:[e.jsx(Ze,{size:14}),t("common.delete")]})]})})]},v.id)}),!b&&s.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:8,children:e.jsx("div",{className:"empty-state",children:t("webcon.noWebcon")})})}):null]})]})})}),c?e.jsx("div",{className:"modal-backdrop",role:"presentation",onMouseDown:()=>f(null),children:e.jsxs("section",{className:"modal-panel webcon-modal",role:"dialog","aria-modal":"true",onMouseDown:v=>v.stopPropagation(),children:[e.jsxs("div",{className:"modal-heading",children:[e.jsxs("div",{children:[e.jsx("h2",{children:c.id?t("webcon.editTitle"):t("webcon.newTitle")}),e.jsx("p",{children:c.domain||t("webcon.modalSubtitle")})]}),e.jsx("button",{className:"icon-button",type:"button","aria-label":t("common.closeMenu"),onClick:()=>f(null),children:e.jsx(ke,{size:18})})]}),e.jsxs("form",{className:"webcon-form",onSubmit:A,children:[e.jsxs("div",{className:"webcon-field-grid",children:[e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.staffOwnerEmail"),!0),e.jsx("input",{className:"config-input",required:!0,type:"email",value:c.email,onChange:v=>P("email",v.target.value),placeholder:t("webcon.staffEmailPlaceholder")})]}),e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.domain"),!0),e.jsx("input",{className:"config-input",required:!0,value:c.domain,onChange:v=>P("domain",v.target.value),onBlur:v=>P("domain",Un(v.target.value)),placeholder:t("webcon.domainPlaceholder")}),e.jsx("span",{className:"webcon-help",children:t("webcon.domainHelp")})]}),e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.landingTitle"),!0),e.jsx("input",{className:"config-input",required:!0,value:c.title,onChange:v=>P("title",v.target.value),placeholder:t("webcon.landingTitlePlaceholder")})]}),e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.description")),e.jsx("input",{className:"config-input",value:c.description,onChange:v=>P("description",v.target.value),placeholder:t("webcon.descriptionPlaceholder")})]}),e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.logoUrl")),e.jsx("input",{className:"config-input",type:"url",value:c.logo,onChange:v=>P("logo",v.target.value),placeholder:t("webcon.logoPlaceholder")})]}),e.jsxs("label",{className:"webcon-field",children:[Tt(t("webcon.backgroundUrl")),e.jsx("input",{className:"config-input",type:"url",value:c.background_url,onChange:v=>P("background_url",v.target.value),placeholder:t("webcon.backgroundPlaceholder")})]}),e.jsxs("div",{className:"webcon-field full",children:[Tt(t("webcon.allowedPlans")),e.jsxs("div",{className:"webcon-plan-picker",children:[D.map(v=>e.jsxs("label",{className:"webcon-plan-option",children:[e.jsx("input",{type:"checkbox",checked:c.plan_ids.includes(v.id),onChange:$=>_(v.id,$.target.checked)}),e.jsx("span",{children:v.name})]},v.id)),D.length===0?e.jsx("span",{className:"webcon-help",children:t("webcon.noPlansLoaded")}):null]}),e.jsx("span",{className:"webcon-help",children:t("webcon.allowedPlansHelp")})]}),e.jsxs("label",{className:"webcon-field full",children:[Tt(t("webcon.customHtml")),e.jsx("textarea",{className:"config-input",rows:5,value:c.custom_html,onChange:v=>P("custom_html",v.target.value),placeholder:"<footer>...</footer>"})]})]}),e.jsxs("div",{className:"webcon-preview",children:[e.jsx("span",{className:"webcon-preview-logo",children:c.logo?e.jsx("img",{src:c.logo,alt:""}):e.jsx(ja,{size:18})}),e.jsxs("div",{children:[e.jsx("strong",{children:c.title||t("webcon.previewTitle")}),e.jsx("span",{children:Un(c.domain)||t("webcon.domainPlaceholder")}),e.jsxs("span",{children:[e.jsx(os,{size:12})," ",ni(c.plan_ids,D,t)]})]})]}),e.jsxs("div",{className:"button-row modal-actions",children:[e.jsx("button",{className:"ghost-button",type:"button",onClick:()=>f(null),children:t("common.cancel")}),e.jsxs("button",{className:"primary-button",type:"submit",disabled:h,children:[e.jsx(rt,{size:16}),t(h?"webcon.saving":"common.save")]})]})]})]})}):null]})}function si(n){return new Date(n*1e3).toLocaleString("vi-VN")}function qn(n){return{id:n==null?void 0:n.id,title:(n==null?void 0:n.title)??"",content:(n==null?void 0:n.content)??"",img_url:(n==null?void 0:n.img_url)??"",tags:n!=null&&n.tags?n.tags.join(", "):""}}function xc(){const n=He(),{t}=me(),[s,l]=o.useState([]),[a,d]=o.useState(null),[c,f]=o.useState(!0),[b,S]=o.useState(!1),[h,j]=o.useState(""),[u,E]=o.useState(""),B=o.useCallback(async()=>{f(!0),j("");try{l(await Ao())}catch(P){j(P instanceof Error?P.message:t("notice.loadFailed"))}finally{f(!1)}},[t]);o.useEffect(()=>{if(!Re()){n.replace("/login");return}B()},[B,n]);async function L(P){var _,A;if(P.preventDefault(),!!a){S(!0),j(""),E("");try{const O=a.tags?a.tags.split(",").map(R=>R.trim()).filter(Boolean):[];await Oo({id:a.id,title:a.title,content:a.content,img_url:a.img_url||null,tags:O.length?O:null}),d(null),(_=window.showToast)==null||_.call(window,t("notice.saveSuccess"),"success"),await B()}catch(O){(A=window.showToast)==null||A.call(window,O instanceof Error?O.message:t("notice.saveFailed"),"error")}finally{S(!1)}}}async function C(P){var _;try{await Ho(P),await B()}catch(A){(_=window.showToast)==null||_.call(window,A instanceof Error?A.message:t("notice.toggleFailed"),"error")}}async function D(P){var _;(_=window.showConfirm)==null||_.call(window,{message:t("notice.deleteConfirm"),onConfirm:async()=>{var A,O;try{await Ro(P),(A=window.showToast)==null||A.call(window,t("notice.deleteSuccess"),"success"),await B()}catch(R){(O=window.showToast)==null||O.call(window,R instanceof Error?R.message:t("notice.deleteFailed"),"error")}}})}return e.jsxs(Ge,{title:t("notice.title"),subtitle:t("notice.subtitle"),children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}function ai(n){return n?new Date(n*1e3).toLocaleString("vi-VN"):"—"}const oi={"en-US":"English","ja-JP":"日本語","ko-KR":"한국어","vi-VN":"Tiếng Việt","zh-CN":"简体中文","zh-TW":"繁體中文"};function ri(n){return{id:n==null?void 0:n.id,category:(n==null?void 0:n.category)??"",title:(n==null?void 0:n.title)??"",body:(n==null?void 0:n.body)??"",language:(n==null?void 0:n.language)??"",sort:(n==null?void 0:n.sort)!=null?String(n.sort):""}}function fc(){const n=He(),{t}=me(),[s,l]=o.useState([]),[a,d]=o.useState(null),[c,f]=o.useState(!0),[b,S]=o.useState(!1),[h,j]=o.useState(""),[u,E]=o.useState(""),B=o.useCallback(async()=>{f(!0),j("");try{l(await Wo())}catch(_){j(_ instanceof Error?_.message:t("knowledge.loadFailed"))}finally{f(!1)}},[t]);o.useEffect(()=>{if(!Re()){n.replace("/login");return}B()},[B,n]);async function L(_){var A;try{const O=await Ko(_.id);d(ri(O))}catch(O){(A=window.showToast)==null||A.call(window,O instanceof Error?O.message:t("knowledge.detailFailed"),"error")}}async function C(_){var A,O;if(_.preventDefault(),!!a){S(!0),j(""),E("");try{await Yo({id:a.id,category:a.category,title:a.title,body:a.body,language:a.language||null,sort:a.sort?Number(a.sort):null}),d(null),(A=window.showToast)==null||A.call(window,t("knowledge.saveSuccess"),"success"),await B()}catch(R){(O=window.showToast)==null||O.call(window,R instanceof Error?R.message:t("knowledge.saveFailed"),"error")}finally{S(!1)}}}async function D(_){var A;try{await Zo(_),await B()}catch(O){(A=window.showToast)==null||A.call(window,O instanceof Error?O.message:t("knowledge.toggleFailed"),"error")}}async function P(_){var A;(A=window.showConfirm)==null||A.call(window,{message:t("knowledge.deleteConfirm"),onConfirm:async()=>{var O,R;try{await Jo(_),(O=window.showToast)==null||O.call(window,t("knowledge.deleteSuccess"),"success"),await B()}catch(v){(R=window.showToast)==null||R.call(window,v instanceof Error?v.message:t("knowledge.deleteFailed"),"error")}}})}return e.jsxs(Ge,{title:t("knowledge.title"),subtitle:t("knowledge.subtitle"),children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
