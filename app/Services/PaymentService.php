...
class PaymentService
{
    ...
    public function __construct($method, $id = NULL, $uuid = NULL)
    {
        ...
        if (!class_exists($this->class)) abort(500, 'Không tìm thấy cổng thanh toán');
    ...
    {
        if (!$this->config['enable']) abort(500, 'Cổng thanh toán chưa được bật');
    ...
    public function pay($order)
    {
        ...
        $notifyUrl = url("/api/v3/guest/payment/notify/{$this->method}/{$this->config['uuid']}");
