...
class Surge
{
    ...
    public function handle()
    {
        ...
        foreach ($servers as $item) {
            ...
            if ($item['type'] === 'shadowsocks') {
                ...
                // [Proxy Group]
                $proxyGroup .= $item['name'] . ', ';
            }elseif ($item['type'] === 'hysteria' && $item['version'] === 2) { //Surge chỉ hỗ trợ Hysteria2
                // [Proxy]
        ...
        $subscribeInfo = "title={$appName}Thông tin đăng ký, content=Dung lượng tải lên:{$upload}GB\\nDung lượng tải xuống:{$download}GB\\nDung lượng còn lại:{$useTraffic}GB\\nDung lượng gói:{$totalTraffic}GB\\nThời gian hết hạn:{$expireDate}";
    ...
    //Tài liệu tham khảo: https://manual.nssurge.com/policy/proxy.html
