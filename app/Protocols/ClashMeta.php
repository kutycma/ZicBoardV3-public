...
class ClashMeta
{
    ...
    public function handle()
    {
        ...
        foreach ($servers as $item) {
            // Singbox-style inline adaptation: unwrap ZicNode.
        ...
        $yaml = str_replace('$app_name', config('zicboard.app_name', 'ZicBoard'), $yaml);
        return $yaml;
    }
    ...
    public static function buildVless($uuid, $server)
    {
        ...
        if ($protectedEncryption) {
            $array['encryption'] = $protectedEncryption;
        }
    ...
    public static function buildHysteria($password, $server)
    {
        ...
        if ($server['version'] === 2) {
            ...
            //Todo:Hoàn thiện tải lên/tải xuống client
