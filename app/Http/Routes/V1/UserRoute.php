...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get ('/device/fetch', 'V1\\User\\UserDeviceController@fetch');
            $router->post('/device/drop', 'V1\\User\\UserDeviceController@drop');
            $router->post('/device/ban', 'V1\\User\\UserDeviceController@ban');
            // Subscription
            $router->get ('/subscription/fetch', 'V1\\User\\SubscriptionController@fetch');
            $router->post('/subscription/note', 'V1\\User\\SubscriptionController@updateNote');
            $router->post('/subscription/changeSNI', 'V1\\User\\SniController@changeSNI');
            // SNI
